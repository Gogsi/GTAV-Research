	...
	switch (iLocal_7044)
	{
		...
		case 1:
			if ((((((STREAMING::HAS_MODEL_LOADED(iLocal_63) && STREAMING::HAS_MODEL_LOADED(joaat("dominator"))) && STREAMING::HAS_MODEL_LOADED(joaat("carbonizzare"))) && VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(1, &cLocal_76)) && VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(2, &cLocal_76)) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED(cLocal_57)) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED(cLocal_56))
			{
				...
				if (GlobalFunc_8315() == 0 && Global_Mission_Fail_State.f_12[1] == 0)
				{
					iLocal_7050 = 1;
				}
				...
				func_562();
				GlobalFunc_563(1);
				GlobalFunc_Checkpoint1(7, "VEHICLE ESCAPE", 1, 0, 0, 1);
				iLocal_7045 = 0;
...
void func_593()//Position - 0x6360B
{
	...
	switch (iLocal_7024)
	{
		...
		case 1:
			...
			{
				GlobalFunc_Checkpoint1(6, "ESCAPE MUSEUM", 0, 0, 0, 1);
		...
		case 2:
			...
			{
				if (GlobalFunc_8315() == 2 && Global_Mission_Fail_State.f_12[1] == 0)
				{
					iLocal_4051 = func_28();
					func_156(1, 1, 1, 0, 0, 0);
		...
		case 5:
			...
			if (func_595() || !GlobalFunc_Is_Player_In_Angled_Area(&Local_7034))
			{
				if (GlobalFunc_8315() == 2)
				{
...
void func_640()//Position - 0x654EB
{
	...
	switch (iLocal_6946)
	{
		...
		case 1:
			...
			{
				GlobalFunc_Checkpoint1(5, "DAVE ESCAPES", 0, 0, 0, 1);
...
void func_668()//Position - 0x66ABA
{
	if (!iLocal_6340)
	{
		if (GlobalFunc_Is_Player_In_Angled_Area(&Local_6164))
		{
	...
	if (!iLocal_6341)
	{
		if (GlobalFunc_Is_Player_In_Angled_Area(&Local_6172))
		{
	...
	if (!iLocal_6342)
	{
		if (GlobalFunc_Is_Player_In_Angled_Area(&Local_6180))
		{
	...
	if (!iLocal_6343)
	{
		if (GlobalFunc_Is_Player_In_Angled_Area(&Local_6188))
		{
	...
	if (!iLocal_6344)
	{
		if (GlobalFunc_Is_Player_In_Angled_Area(&Local_6196))
		{
			iLocal_6344 = 1;
		}
	}
...
void func_673()//Position - 0x66F35
{
	...
	if (iLocal_6735 > 1)
	{
		...
		if (!iLocal_6921)
		{
			if (GlobalFunc_Is_Player_In_Angled_Area(&Local_6852))
			{
	...
	switch (iLocal_6735)
	{
		...
		case 1:
			if (((((((STREAMING::HAS_MODEL_LOADED(iLocal_64) && STREAMING::HAS_MODEL_LOADED(iLocal_65)) && STREAMING::HAS_MODEL_LOADED(iLocal_63)) && STREAMING::HAS_MODEL_LOADED(iLocal_67)) && STREAMING::HAS_ANIM_DICT_LOADED(cLocal_59)) && STREAMING::HAS_ANIM_DICT_LOADED(cLocal_60)) && STREAMING::HAS_ANIM_DICT_LOADED(cLocal_61)) && VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(4, &cLocal_76))
			{
				...
				GlobalFunc_Checkpoint1(4, "DAVE BY FOUNTAIN", 0, 0, 0, 1);
				GlobalFunc_2904(&iLocal_3038, 0, 1);
				func_676();
				func_675();
...
void func_699()//Position - 0x68D1D
{
	...
	switch (iLocal_6739)
	{
		...
		case 1:
			if (GlobalFunc_Is_Player_In_Angled_Area(&Local_6788))
			{
...
void func_703()//Position - 0x6911F
{
	...
	switch (iLocal_6738)
	{
		...
		case 1:
			if (GlobalFunc_Is_Player_In_Angled_Area(&Local_6780))
			{
				iVar4 = 0;
...
void func_707()//Position - 0x696DF
{
	if (!iLocal_6917)
	{
		if (GlobalFunc_Is_Player_In_Angled_Area(&Local_6820))
		{
	...
	if (!iLocal_6918)
	{
		if (GlobalFunc_Is_Player_In_Angled_Area(&Local_6828))
		{
	...
	if (!iLocal_6919)
	{
		if (GlobalFunc_Is_Player_In_Angled_Area(&Local_6836))
		{
	...
	if (!iLocal_6920)
	{
		if (GlobalFunc_Is_Player_In_Angled_Area(&Local_6844))
		{
			iLocal_6920 = 1;
			iLocal_4046 = 1;
		}
...
void func_712()//Position - 0x69DEC
{
	switch (iLocal_6743)
	{
		...
		case 1:
			...
			{
				if (GlobalFunc_Is_Player_In_Angled_Area(&Local_6900))
				{
...
void func_713()//Position - 0x69E43
{
	switch (iLocal_6742)
	{
		...
		case 1:
			if ((GlobalFunc_Is_Player_In_Angled_Area(&Local_6868) && CAM::IS_SPHERE_VISIBLE(-2275.623f, 331.0665f, 185.0653f, 1f)) && func_623(&iLocal_5018) != 0)
			{
				if (bLocal_6924)
				{
					iLocal_6736 = 7;
...
void func_715()//Position - 0x69F86
{
	...
	switch (iLocal_6685)
	{
		...
		case 1:
			if ((STREAMING::HAS_MODEL_LOADED(iLocal_64) && STREAMING::HAS_MODEL_LOADED(iLocal_65)) && STREAMING::HAS_MODEL_LOADED(iLocal_63))
			{
				GlobalFunc_Checkpoint1(3, "TREVOR SAVES DAVE", 0, 0, 0, 1);
				func_676();
...
int func_724()//Position - 0x6A9C3
{
	switch (iLocal_6661)
	{
		case 0:
			...
			GlobalFunc_Checkpoint1(2, "TREVOR SHOOTS HELICOPTER", 0, 0, 0, 1);
			iLocal_6661 = 1;
			break;
	...
	switch (iLocal_6561)
	{
		...
		case 1:
			if (((((((((STREAMING::HAS_MODEL_LOADED(iLocal_64) && STREAMING::HAS_MODEL_LOADED(iLocal_65)) && STREAMING::HAS_MODEL_LOADED(iLocal_67)) && STREAMING::HAS_MODEL_LOADED(iLocal_63)) && STREAMING::HAS_MODEL_LOADED(joaat("ig_paper"))) && STREAMING::HAS_MODEL_LOADED(joaat("p_gdoor1colobject_s"))) && STREAMING::HAS_MODEL_LOADED(joaat("ig_andreas"))) && VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(50, &cLocal_76)) && VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(3, &cLocal_76)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK(&cLocal_80, 0))
			{
				...
				GlobalFunc_Checkpoint1(1, "FIRST AREA", 0, 0, 0, 1);
		...
		case 2:
			...
			if (func_741(&Local_4108, &Local_4209, &Local_4310) || GlobalFunc_Is_Player_In_Angled_Area(&Local_6578))
			{
		...
		case 3:
			if (GlobalFunc_Is_Player_In_Angled_Area(&Local_6599) || GlobalFunc_5182(&uLocal_6623) >= 10f)
			{
				func_739();
				if (GlobalFunc_234(iLocal_4050))
				{
		...
		case 4:
			func_738();
			if (GlobalFunc_Is_Player_In_Angled_Area(&Local_6607))
			{
				AUDIO::STOP_STREAM();
				AUDIO::LOAD_STREAM("MIC_3_HELICOPTER_SHOT_DOWN_MASTER", 0);
				iLocal_6561 = 6;
...
void func_738()//Position - 0x6C47E
{
	if (!iLocal_6597)
	{
		if (GlobalFunc_Is_Player_In_Angled_Area(&Local_6615))
		{
...
void func_753()//Position - 0x6CB69
{
	...
	if (GlobalFunc_Is_Mission_Retry() && !ENTITY::DOES_ENTITY_EXIST(Local_318[4 /*25*/]))
	{
...
void func_806()//Position - 0x72005
{
	...
	{
		if (GlobalFunc_Is_Player_In_Angled_Area(&Local_6108) || GlobalFunc_Is_Player_In_Angled_Area(&Local_6116))
		{
			func_866(5);
		}
	}
	if (iLocal_3030 == 2)
	{
		if (GlobalFunc_Is_Player_In_Angled_Area(&Local_6124))
		{
			func_866(5);
		}
	}
			...
			switch (iLocal_3030)
			{
				...
				case 6:
					...
					if (Global_Mission_Fail_State.f_12[0] == 1)
					{
						...
						else if (Global_Mission_Fail_State.f_12[1] == 0)
						{
							if (GlobalFunc_234(func_28()))
							{
			...
			if (CAM::IS_SCREEN_FADED_OUT() || !CAM::IS_SCREEN_FADING_IN())
			{
				switch (iLocal_3030)
				{
					...
					case 6:
						...
						if (Global_Mission_Fail_State.f_12[0] == 1 && Global_Mission_Fail_State.f_12[1] == 0)
						{
							CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0);
							CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(-30f, 1065353216);
						}
...
void func_840(var uParam0)//Position - 0x77456
{
	...
	switch (iLocal_3120)
	{
		case 1:
			...
			if (GlobalFunc_8315() == 0 || (GlobalFunc_8315() == 2 && Global_Mission_Fail_State.f_12[1] == 1))
			{
