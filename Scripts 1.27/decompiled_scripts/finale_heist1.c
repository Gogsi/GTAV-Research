...
void func_9()//Position - 0x706
{
	switch (iLocal_5436)
	{
		case 0:
			...
			GlobalFunc_11043(6, "Stage 6: Drop off point", 1, 0, 0, 1);
			iLocal_3520 = 0;
			iLocal_5436++;
			break;
				...
				case 2:
					switch (iLocal_3475)
					{
						case 0:
							...
							{
								if (!func_21(14, 0) || Global_89962.f_12[1] == 1)
								{
									iLocal_3523 = 0;
									iLocal_3519 = MISC::GET_GAME_TIMER();
									iLocal_3475 = 1;
...
void func_202()//Position - 0x10C1E
{
	switch (iLocal_5436)
	{
		case 0:
			...
			GlobalFunc_4935();
			GlobalFunc_11043(5, "Stage 5: Construction hole", 0, 0, 0, 1);
			iLocal_9234 = 0;
			iLocal_9233 = 0;
			iLocal_3521 = 0;
			iLocal_3532 = 0;
...
void func_230()//Position - 0x13675
{
	...
	switch (iLocal_5436)
	{
		case 0:
			...
			iLocal_9230 = 0;
			iLocal_9231 = 0;
			GlobalFunc_11043(4, "Stage 4: Follow truck", 0, 0, 0, 1);
					...
					switch (iLocal_3294)
					{
						case 0:
							...
							if (GlobalFunc_9202(&Local_3261, Local_3011, 0.1f, 0.1f, 2f, 1, func_196(), 0, 0, "", "", "", "", "", 0, 1, 1, -1) || (HUD::DOES_BLIP_EXIST(Local_3261.f_5) && MISC::GET_DISTANCE_BETWEEN_COORDS(Local_3011, ENTITY::GET_ENTITY_COORDS(func_129(), 1), 1) < 15f))
							{
								...
								GlobalFunc_11043(3, "Stage 3: Get in Position", 0, 0, 0, 1);
								iLocal_3294 = 1;
								iLocal_3470 = 0;
								iLocal_3521 = 0;
								iLocal_3522 = 0;
	...
	switch (iLocal_5436)
	{
		case 0:
			...
			if (!Local_3356.f_20)
			{
				...
				{
					if ((((GlobalFunc_199() && Global_89999 == 1) && Global_89962.f_12[0] == 1) && !Global_84544) && !bLocal_5441)
					{
						iLocal_3437 = 2;
						iLocal_5436 = 3;
					...
					if ((ENTITY::IS_ENTITY_AT_COORD(func_130(), Local_3007, 3f, 3f, 2f, 0, 1, 0) || ((((!func_21(13, 45) && !ENTITY::IS_ENTITY_ON_SCREEN(Local_3032[0 /*2*/])) && ENTITY::IS_ENTITY_OCCLUDED(Local_3032[0 /*2*/])) && (MISC::GET_GAME_TIMER() - iLocal_3391) > 9000) && (MISC::GET_GAME_TIMER() - iLocal_3400) > 15000)) || ((HUD::DOES_BLIP_EXIST(Local_3261.f_5) && GlobalFunc_713(func_129(), Local_3011, 1) < 100f) && (MISC::GET_GAME_TIMER() - iLocal_3391) > 9000))
					{
						...
						if (iLocal_3479 == 3)
						{
							if (GlobalFunc_10618(&uLocal_3096, "FH1AUD", "FH1_TRVBB", 7, 0, 0, 0))
							{
								...
								iLocal_5436 = 0;
								func_211(2);
								GlobalFunc_11043(2, "Stage 2: Back of bank", 0, 0, 0, 1);
							}
						}
					}
				}
...
void func_517()//Position - 0x4411B
{
	switch (iLocal_5436)
	{
		...
		case 1:
			if (CUTSCENE::IS_CUTSCENE_PLAYING())
			{
				if (GlobalFunc_2(0) && CAM::IS_SCREEN_FADED_OUT())
				{
					CAM::DO_SCREEN_FADE_IN(800);
				}
		...
		case 3:
			...
			if ((((((iLocal_3534 && iLocal_3536) && iLocal_3537) && iLocal_3538) && bLocal_3539) || GlobalFunc_199()) || bLocal_5441)
			{
				GlobalFunc_562(76);
					...
					if (ENTITY::IS_ENTITY_AT_COORD(func_130(), Local_3003, 4f, 4f, 2f, 0, 1, 0) || ((((!func_21(12, 35) && !ENTITY::IS_ENTITY_ON_SCREEN(Local_3032[0 /*2*/])) && ENTITY::IS_ENTITY_OCCLUDED(Local_3032[0 /*2*/])) && (MISC::GET_GAME_TIMER() - iLocal_3400) > 15000) && (MISC::GET_GAME_TIMER() - iLocal_3391) > 10000))
					{
						...
						if (iLocal_3479 == 3)
						{
							if (!HUD::IS_MESSAGE_BEING_DISPLAYED())
							{
								...
								{
									iLocal_3479 = 4;
									GlobalFunc_11043(1, "Stage 1: Front of bank", 0, 0, 0, 1);
									iLocal_5436 = 0;
									func_211(1);
									iLocal_3400 = MISC::GET_GAME_TIMER();
								}
...
void func_639()//Position - 0x5331C
{
	...
	if (bLocal_5439 == 1)
	{
		...
		else if (iLocal_5434 == 3)
		{
			...
			if (!GlobalFunc_188())
			{
				func_816(iLocal_5440, &Var0, &uVar3, Global_89962.f_12[2]);
...
void func_806()//Position - 0x80FB6
{
	...
	if (Global_89962.f_12[1] == 1)
	{
		if ((GlobalFunc_199() && Global_84544) && (Global_89999 == 3 || Global_89999 == 2))
		{
...
void func_825()//Position - 0x831E4
{
	...
	else
	{
		...
		GlobalFunc_11043(0, "Stage 0: Strip club", 0, 0, 0, 1);
		iLocal_5435 = 0;
		func_218(0, 0);
