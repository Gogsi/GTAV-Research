...
void __EntryFunction__()//Position - 0x0
{
	...
	Local_3332 = { -16.5304f, -1473.121f, 29.611f };
	Local_3335 = { 401.637f, -1633.3f, 28.2928f };
	...
	{
		Global_SAVE_DATA.TOWING_SAVED_STRUCT.TOWING_iJobsCompleted = 4;
	}
	...
	while (true)
	{
		...
		RECORDING::_0x208784099002BC30("RC_TON5", 0);
		...
		if (!iLocal_3344)
		{
			...
			{
				iLocal_3348 = GlobalFunc_Get_Mission_Fail_Checkpoint();
				if (!Global_84544)
				{
					if (iLocal_3348 == 0)
					{
					...
					else if (iLocal_3348 == 2)
					{
						GlobalFunc_5116(Local_2853, fLocal_2856, 1, 0);
					}
				}
				else if (iLocal_3348 == 0)
				{
					GlobalFunc_5116(404.1494f, -1630.793f, 28.2928f, 231.5304f, 1, 0);
				}
				else if (iLocal_3348 == 1)
...
void func_5()//Position - 0x5A6
{
	if (Global_SAVE_DATA.TOWING_SAVED_STRUCT.TOWING_iJobsCompleted < 5)
	{
		Global_SAVE_DATA.TOWING_SAVED_STRUCT.TOWING_iJobsCompleted = 5;
	}
	SCRIPT::REQUEST_SCRIPT("ambient_TonyaCall5");
	if (SCRIPT::HAS_SCRIPT_LOADED("ambient_TonyaCall5"))
	{
		GlobalFunc_11330(212, 1);
		SYSTEM::START_NEW_SCRIPT("ambient_TonyaCall5", 1424);
		SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED("ambient_TonyaCall5");
		func_638();
	}
}
	...
	switch (iLocal_3317)
	{
		...
		case 3:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_3329))
			{
				...
				{
					iLocal_3329 = VEHICLE::CREATE_VEHICLE(joaat("towtruck"), Local_3335, fLocal_3338, 1, 1);
					iLocal_2933 = iLocal_3329;
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_2933, 1, 0);
					AUDIO::SET_VEH_RADIO_STATION(iLocal_2933, "RADIO_03_HIPHOP_NEW");
					MISC::CLEAR_AREA(Local_3335, 25f, 1, 1, 0, 0);
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_3329))
					{
						HUD::REMOVE_BLIP(&uLocal_2766);
						...
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
						{
							if (!GlobalFunc_111())
							{
								if (!iLocal_494)
								{
									if (!GlobalFunc_111())
									{
										if (GlobalFunc_10618(&uLocal_526, "TOWAUD", "TOW_HERE", 8, 0, 0, 0))
										{
									...
									if (!bLocal_3339)
									{
										if (GlobalFunc_226(&uLocal_3351))
										{
											if (GlobalFunc_5182(&uLocal_3351) > 20f)
											{
												if (!GlobalFunc_111())
												{
													if (GlobalFunc_10618(&uLocal_526, "TOWAUD", "TOW_WAITING", 8, 0, 0, 0))
													{
...
void func_506()//Position - 0x3B51A
{
	...
	switch (iLocal_3349)
	{
		case 0:
							...
							if (!HUD::IS_MESSAGE_BEING_DISPLAYED())
							{
								if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
								{
									if (!iLocal_495)
									{
										if (!GlobalFunc_111())
										{
											if (GlobalFunc_10618(&uLocal_526, "TOWAUD", "TOW_CAR", 8, 0, 0, 0))
											{
												iLocal_495 = 1;
											}
										}
						...
						if (!iLocal_3341)
						{
							if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID()) && !ENTITY::IS_ENTITY_DEAD(iLocal_2765))
							{
								if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
								{
									if (!GlobalFunc_111())
									{
										if (GlobalFunc_10618(&uLocal_526, "TOWAUD", "TOW_CARWAIT", 8, 0, 0, 0))
										{
											iLocal_3341 = 1;
										}
									}
			...
			if (!iLocal_3342)
			{
				if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID()))
				{
					...
					{
						if (GlobalFunc_10618(&uLocal_526, "TOWAUD", "TOW_JACK", 8, 0, 0, 0))
						{
							iLocal_3342 = 1;
						}
					}
		...
		case 1:
			if (!GlobalFunc_111())
			{
				if (GlobalFunc_10618(&uLocal_526, "TOWAUD", "TOW_CHAT", 8, 0, 0, 0))
				{
					iLocal_3349 = 2;
				}
			}
...
void func_517()//Position - 0x3BDE8
{
	...
	switch (iLocal_3317)
	{
		case 0:
			...
			CUTSCENE::REQUEST_CUTSCENE("tonya_mcs_3", 8);
			GlobalFunc_8938();
			iLocal_3317 = 2;
			break;
		...
		case 2:
			if (GlobalFunc_226(&uLocal_3354))
			{
				if ((GlobalFunc_5182(&uLocal_3354) > 3f || (iLocal_3347 && !GlobalFunc_111())) || (GlobalFunc_156(PLAYER::PLAYER_PED_ID(), iLocal_2765, 1) < 3.5f && !GlobalFunc_111()))
				{
					iLocal_3317 = 1;
				}
			}
		...
		case 1:
			if (GlobalFunc_Has_Cutscene_Loaded())
			{
				...
				uLocal_3350 = PATHFIND::ADD_NAVMESH_BLOCKING_OBJECT(Local_3332, 5f, 5f, 5f, 0f, 0, 7);
				GlobalFunc_9161();
		...
		case 4:
			...
			GlobalFunc_601(23, 0);
			PATHFIND::REMOVE_NAVMESH_BLOCKING_OBJECT(uLocal_3350);
			CAM::RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
			iLocal_3316 = 2;
			iLocal_3317 = 0;
			break;
...
void func_546()//Position - 0x3D228
{
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_2933))
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_2933))
		{
			iLocal_2933 = VEHICLE::CREATE_VEHICLE(joaat("towtruck"), Local_3335, fLocal_3338, 1, 1);
...
void func_548()//Position - 0x3D2B0
{
	if (CAM::IS_SCREEN_FADED_OUT())
	{
		func_549();
...
void func_549()//Position - 0x3D33B
{
...
void func_654(var uParam0, bool bParam1)//Position - 0x40C2E
{
	int iVar0;
