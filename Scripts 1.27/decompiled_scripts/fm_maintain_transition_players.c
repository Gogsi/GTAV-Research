	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_138(&Var1, -99, -99, Global_SAVE_DATA.COMPONENTS_ARRAY.PP_INFO_STRUCT.f_196[0], Global_SAVE_DATA.COMPONENTS_ARRAY.PP_INFO_STRUCT.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_138(&Var1, -99, -99, Global_SAVE_DATA.COMPONENTS_ARRAY.PP_INFO_STRUCT.f_196[1], Global_SAVE_DATA.COMPONENTS_ARRAY.PP_INFO_STRUCT.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_138(&Var1, -99, -99, Global_SAVE_DATA.COMPONENTS_ARRAY.PP_INFO_STRUCT.f_196[2], Global_SAVE_DATA.COMPONENTS_ARRAY.PP_INFO_STRUCT.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_214()//Position - 0x228E8
{
	...
	while (iVar0 < 147)
	{
		if (!Global_SAVE_DATA.CHARSHEET_SAVED_ARRAY[iVar0 /*29*/].f_12[3] == 2)
		{
			Global_SAVE_DATA.CHARSHEET_SAVED_ARRAY[iVar0 /*29*/].f_12[3] = 0;
			Global_SAVE_DATA.CHARSHEET_SAVED_ARRAY[iVar0 /*29*/].f_24[3] = 0;
			Global_SAVE_DATA.CHARSHEET_SAVED_ARRAY[iVar0 /*29*/].f_19[3] = 0;
		}
		iVar0++;
	}
}
...
void func_216()//Position - 0x229C9
{
	...
	while (iVar0 < 35)
	{
		if (Global_SAVE_DATA.TEXT_MESSAGES_SAVED_ARRAY[iVar0 /*104*/].f_99[3] == 1)
		{
			...
			Global_SAVE_DATA.TEXT_MESSAGES_SAVED_ARRAY[iVar0 /*104*/].f_99[3] = 0;
		}
		iVar0++;
	}
