...
int func_1(int iParam0, var uParam1, struct<3> Param2, struct<3> Param5, var uParam8)//Position - 0xF0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_2(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x5CB
{
	struct<15> Var0;
	int iVar15;
...
void func_3(int iParam0)//Position - 0x74B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_4(int iParam0)//Position - 0x80F
{
	switch (iParam0)
	{
		case 0:
...
bool func_5(bool bParam0)//Position - 0x879
{
...
int func_6(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)//Position - 0x8A4
{
	struct<14> Var0;
...
void func_8(struct<3> Param0, struct<3> Param3, var uParam6)//Position - 0xA03
{
	if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
	{
		if (MISC::HAS_BULLET_IMPACTED_IN_BOX(Param0, Param3, 1, 1))
		{
			*uParam6++;
			if (*uParam6 > 6)
			{
		...
		else if ((FIRE::IS_EXPLOSION_IN_AREA(0, Param0, Param3) || FIRE::IS_EXPLOSION_IN_AREA(2, Param0, Param3)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(Param0, Param3, joaat("weapon_grenadelauncher"), 1))
		{
			Global_85390 = 5;
		}
	}
...
void func_9(struct<3> Param0, struct<3> Param3)//Position - 0xA7E
{
	int iVar0;
...
void func_10(var uParam0, var uParam1)//Position - 0xAC2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_11(int iParam0)//Position - 0xB79
{
	int iVar0;
...
void func_12(struct<3> Param0, struct<3> Param3, var uParam6)//Position - 0xBDC
{
...
void func_13(struct<3> Param0, struct<3> Param3)//Position - 0xC53
{
	int iVar0;
	...
	if (WEAPON::GET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), &iVar0, 1))
	{
		...
		{
			if (MISC::IS_PROJECTILE_TYPE_IN_AREA(Param0, Param3, iVar0, 1))
			{
				Global_85390 = 0;
			}
		}
...
bool func_14(struct<3> Param0, struct<3> Param3)//Position - 0xC8A
{
	return ((Param0.x == Param3.x && Param0.f_1 == Param3.f_1) && Param0.f_2 == Param3.f_2);
}

int func_15(int iParam0, int iParam1)//Position - 0xCB3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_16(int iParam0)//Position - 0xD1D
{
	if (iParam0 < 9)
	{
...
int func_17(int iParam0, int iParam1)//Position - 0xD3B
{
	int iVar0;
...
int func_18(int iParam0)//Position - 0xEC5
{
	if (iParam0 == 145)
	{
		return 7;
...
bool func_21(int iParam0)//Position - 0x1036
{
	return Global_34913 == iParam0;
}

int func_22(int iParam0)//Position - 0x1044
{
	int iVar0;
	int iVar1;
...
int func_23(int iParam0)//Position - 0x1081
{
	if (func_25(iParam0))
	{
...
int func_24(int iParam0)//Position - 0x10AB
{
	if (func_25(iParam0))
	{
		if ((Global_SAVE_DATA.isGameflowActive || Global_3) || func_5(0))
		{
...
bool func_25(int iParam0)//Position - 0x10F9
{
	return iParam0 < 3;
}

int func_26(int iParam0)//Position - 0x1105
{
	switch (iParam0)
	{
		case 0:
...
bool func_27(int iParam0)//Position - 0x113C
{
	func_20();
	return iParam0 == Global_SAVE_DATA.COMPONENTS_ARRAY.PP_INFO_STRUCT.f_3213;
}

int func_28(int iParam0)//Position - 0x1158
{
	if (iParam0 == 0)
	{
		return 0;
...
bool func_29(var uParam0, var uParam1)//Position - 0x1186
{
	return (uParam0 && uParam1) != 0;
}

int func_30()//Position - 0x1195
{
	func_20();
...
int func_31(int iParam0)//Position - 0x11DB
{
...
void func_32(var uParam0, var uParam1, var uParam2, var uParam3, struct<3> Param4, char* sParam7)//Position - 0x1208
{
	int iVar0;
	struct<3> Var1;
...
void func_33(char* sParam0, int iParam1)//Position - 0x1465
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, 1, iParam1);
}

void func_34(var uParam0)//Position - 0x147C
{
	func_35(uParam0, 0f);
}

void func_35(var uParam0, float fParam1)//Position - 0x148B
{
...
float func_36(bool bParam0)//Position - 0x14B9
{
	var uVar0;
...
int func_37(var uParam0, float fParam1)//Position - 0x1501
{
	if (func_40(uParam0))
	{
...
float func_38(var uParam0)//Position - 0x1523
{
	if (func_40(uParam0))
	{
		if (func_39(uParam0))
...
bool func_39(var uParam0)//Position - 0x1562
{
	return MISC::IS_BIT_SET(*uParam0, 2);
}

bool func_40(var uParam0)//Position - 0x1572
{
	return MISC::IS_BIT_SET(*uParam0, 1);
}

int func_41(int iParam0, struct<3> Param1, float fParam4)//Position - 0x1582
{
	if (!func_42(iParam0))
	{
		return 0;
	}
	if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Param1, 1) >= (100f * fParam4))
	{
		return 0;
	}
	if (Global_90012)
...
int func_42(int iParam0)//Position - 0x15C6
{
	...
	if (MISC::GET_RANDOM_EVENT_FLAG() && Global_97343)
	{
		return 0;
	}
	if (!func_27(iParam0))
...
int func_44(int iParam0)//Position - 0x169C
{
	if (Global_34913 == 15)
	{
		return 0;
...
bool func_45(int iParam0)//Position - 0x16BE
{
	return func_46(iParam0, Global_34913);
}

int func_46(int iParam0, int iParam1)//Position - 0x16CF
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_48(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x18E1
{
...
void func_49(struct<4> Param0)//Position - 0x197C
{
	Local_111 = { Param0 };
	uLocal_114 = Param0.f_3;
}

void func_50()//Position - 0x1992
{
	int iVar0;
	int iVar1;
...
void func_51(int iParam0)//Position - 0x1A00
{
	int iVar0;
	int iVar1;
...
int func_52(int iParam0)//Position - 0x1A3E
{
	if (!func_25(iParam0))
	{
		return Global_SAVE_DATA.CHARSHEET_SAVED_ARRAY[iParam0 /*29*/];
...
int func_53(int iParam0, int iParam1)//Position - 0x1A69
{
	*iParam1 = 0;
	switch (iParam0)
	{
...
void func_54(int iParam0)//Position - 0x1B74
{
	switch (Global_85373[iParam0])
	{
		...
		default:
			Global_SAVE_DATA.FAMILY_SAVED_DATA[iParam0] = Global_85373[iParam0];
			break;
	}
}

int func_55(int iParam0)//Position - 0x1BC0
{
	switch (iParam0)
	{
		case 0:
...
void func_56(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9)//Position - 0x1BED
{
	int iVar0;
	struct<8> Var1;
	int iVar17;
...
int func_57(int iParam0)//Position - 0x1EA9
{
	int iVar0;
	int iVar1;
...
void func_58(int iParam0)//Position - 0x1FD0
{
	int iVar0;
	struct<10> Var1;
...
void func_59(int iParam0)//Position - 0x2089
{
	int iVar0;
	struct<14> Var1;
...
void func_60(int iParam0)//Position - 0x2151
{
	struct<15> Var0;
	int iVar15;
	int iVar16;
...
void func_61(int iParam0)//Position - 0x21FE
{
	struct<15> Var0;
	int iVar15;
	int iVar16;
	...
	while (iVar15 < Global_SAVE_DATA.COMM_CONTROL_DATA_STRUCT.No_Missed_Calls)
	{
		...
		{
			func_62(Global_SAVE_DATA.COMM_CONTROL_DATA_STRUCT.COMM_CONTROL_MISSED_CALLS_ARRAY[iVar15 /*15*/].f_6);
			iVar16 = iVar15;
...
int func_62(int iParam0)//Position - 0x22BA
{
	int iVar0;
...
void func_63(int iParam0, int iParam1)//Position - 0x232B
{
	if (Global_97[iParam0 /*10*/].f_8 != 138)
	{
		if (iParam1 > 3)
...
void func_64(int iParam0)//Position - 0x236E
{
	int iVar0;
	var uVar1;
	struct<15> Var2;
...
void func_66(int iParam0)//Position - 0x248A
{
	if (iParam0 != -1)
	{
...
void func_67(int iParam0, int iParam1)//Position - 0x24A2
{
	Global_24504[iParam0 /*11*/].f_10 = iParam1;
}

int func_68(int iParam0)//Position - 0x24B5
{
	if (iParam0 != -1)
	{
...
int func_69()//Position - 0x24D4
{
	...
	while (iVar23 < 11)
	{
		...
		{
			OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(iVar5, 3, 1, 1);
...
void func_70(int iParam0, bool bParam1)//Position - 0x25C2
{
	if (bParam1)
	{
...
void func_71(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, char* sParam5, int iParam6)//Position - 0x25EE
{
	switch (iParam0)
	{
		case 0:
...
int func_72(int iParam0, char* sParam1)//Position - 0x28B6
{
	switch (iParam0)
	{
		case 0:
...
int func_73(var uParam0, var uParam1, char* sParam2)//Position - 0x31D4
{
	AUDIO::STOP_STREAM();
...
void func_74(var uParam0)//Position - 0x3250
{
	if (!PED::IS_PED_INJURED(*uParam0))
	{
		if (TASK::GET_SCRIPT_TASK_STATUS(*uParam0, -2017877118) != 0)
		{
...
void func_75(int iParam0, int iParam1, bool bParam2)//Position - 0x329F
{
	int iVar0;
	bool bVar1;
...
int func_76(int iParam0, int iParam1)//Position - 0x335B
{
	int iVar0;
...
int func_77(int iParam0, char* sParam1, int iParam2)//Position - 0x3394
{
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0))
	{
		return 0;
	...
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0) && !ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iParam0, 1))
		{
