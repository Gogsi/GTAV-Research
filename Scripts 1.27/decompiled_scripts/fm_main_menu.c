...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		if (iLocal_223 != Global_1602437)
		{
			func_15(&Local_103);
			iLocal_223 = Global_1602437;
			MISC::CLEAR_BIT(&(Local_103.f_4), 0);
		}
		if (func_14() == 3)
		{
			func_26();
...
bool func_1()//Position - 0x2C1
{
	return Global_1312366;
}

int func_2(var uParam0)//Position - 0x2CD
{
	if (!MISC::IS_BIT_SET(*uParam0, 2))
	{
		...
		if (SCRIPT::HAS_SCRIPT_LOADED("FM_Race_Creator"))
		{
			if (!func_3())
			{
				SYSTEM::START_NEW_SCRIPT("FM_Race_Creator", 17000);
...
int func_5(var uParam0)//Position - 0x3B4
{
	if (!MISC::IS_BIT_SET(*uParam0, 2))
	{
		...
		if (SCRIPT::HAS_SCRIPT_LOADED("FM_Deathmatch_Creator"))
		{
			if (!func_3())
			{
				SYSTEM::START_NEW_SCRIPT("FM_Deathmatch_Creator", 17000);
...
int func_6(var uParam0)//Position - 0x419
{
	if (!MISC::IS_BIT_SET(*uParam0, 2))
	{
		...
		if (SCRIPT::HAS_SCRIPT_LOADED("FM_Capture_Creator"))
		{
			if (!func_3())
			{
				SYSTEM::START_NEW_SCRIPT("FM_Capture_Creator", 17000);
...
int func_7(var uParam0)//Position - 0x47E
{
	if (!MISC::IS_BIT_SET(*uParam0, 2))
	{
		...
		if (SCRIPT::HAS_SCRIPT_LOADED("FM_LTS_Creator"))
		{
			if (!func_3())
			{
				SYSTEM::START_NEW_SCRIPT("FM_LTS_Creator", 17000);
...
int func_8(var uParam0)//Position - 0x4E3
{
	if (!MISC::IS_BIT_SET(*uParam0, 2))
	{
		...
		if (SCRIPT::HAS_SCRIPT_LOADED("FM_Mission_Creator"))
		{
			if (!func_3())
			{
				SYSTEM::START_NEW_SCRIPT("FM_Mission_Creator", 17000);
...
void func_10()//Position - 0x5AB
{
	Global_17098.f_5 = 1;
}

bool func_11()//Position - 0x5B9
{
	return (Global_17098.f_5 || Global_17098.f_6);
}

void func_12(var uParam0)//Position - 0x5D1
{
	if (Global_1602437 == 0)
	{
...
bool func_13()//Position - 0x74A
{
	return Global_1312364;
}

int func_14()//Position - 0x756
{
	if (MISC::IS_BIT_SET(Global_1327593.f_102, 1))
	{
		return 1;
	}
	if (MISC::IS_BIT_SET(Global_1327593.f_102, 2))
	{
		MISC::CLEAR_BIT(&(Global_1327593.f_102), 2);
		return 2;
	}
	if (MISC::IS_BIT_SET(Global_1327593.f_102, 3))
	{
		MISC::CLEAR_BIT(&(Global_1327593.f_102), 3);
		return 3;
	}
	return 0;
}

void func_15(var uParam0)//Position - 0x7AB
{
...
void func_16(bool bParam0, bool bParam1, bool bParam2)//Position - 0x8BE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_19(var uParam0)//Position - 0x3CCD
{
	uParam0->f_4 = -1;
	uParam0->f_3 = -1;
	uParam0->f_6 = 0;
...
void func_20(var uParam0, int iParam1)//Position - 0x3CFF
{
	int iVar0;
...
void func_21(char* sParam0)//Position - 0x3DBA
{
	int iVar0;
...
void func_22(var uParam0)//Position - 0x3E99
{
	*uParam0 = -1;
	uParam0->f_1 = -1;
	uParam0->f_2 = 0;
...
void func_23(char* sParam0)//Position - 0x3EBD
{
	int iVar0;
...
void func_24(char* sParam0, int iParam1)//Position - 0x3FE2
{
