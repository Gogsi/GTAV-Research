...
void __EntryFunction__()//Position - 0x0
{
	...
	Local_3335 = { 530.3121f, -171.8575f, 53.8463f };
	fLocal_3338 = 62.9791f;
	Local_3341 = { -10.7897f, -1471.204f, 29.552f };
	fLocal_3344 = 276.1668f;
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		GlobalFunc_10580(1);
		func_590(&uLocal_3042, 1);
		func_573();
	}
	GlobalFunc_5226(61);
	if (!GlobalFunc_Is_Mission_Repeat_Or_Benchmark(0))
	{
		Global_SAVE_DATA.TOWING_SAVED_STRUCT.TOWING_iJobsCompleted = 3;
	}
	...
	PATHFIND::SET_ROADS_IN_ANGLED_AREA(-537.0874f, 129.9377f, 60.97144f, -397.5062f, 126.5231f, 69.54237f, 30f, 0, 0, 1);
	GlobalFunc_587();
	while (true)
	{
		SYSTEM::WAIT(0);
		func_567(&uLocal_3042);
		RECORDING::_0x208784099002BC30("RC_TON4", 0);
		func_551(Local_2981.f_9, 0, 0, 0, 0, 0);
		PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID());
		if (func_550())
		{
			iLocal_3316 = 4;
		}
		func_545(&Local_2778, bLocal_510, &Local_2658, &uLocal_2766, &uLocal_2768, &iLocal_2933, iLocal_2940, 0);
		if (!iLocal_3339)
		{
			if (GlobalFunc_Is_Mission_Retry())
			{
				iLocal_3340 = GlobalFunc_Get_Mission_Fail_Checkpoint();
				if (!Global_84544)
				{
					if (iLocal_3340 == 0)
					{
						GlobalFunc_5116(Local_3341, fLocal_3344, 1, 0);
					}
...
void func_5()//Position - 0x560
{
	GlobalFunc_11330(211, 1);
	func_573();
}
...
int func_202(var uParam0, var uParam1)//Position - 0x24D9B
{
	...
	if (uParam0->f_6)
	{
		...
		switch (uParam0->f_2)
		{
			case 1:
				if (uParam0->f_4)
				{
					...
					{
						iLocal_2646 = func_502(100000f, iLocal_462, Global_SAVE_DATA.TOWING_SAVED_STRUCT.TOWING_iLastNodeIndex);
					}
				}
				else
				{
		...
		{
			iLocal_2834 = Local_1912[func_500() /*28*/].f_27;
		}
		func_499();
		bLocal_2701 = false;
	...
	{
		func_495(&iLocal_2933, &uLocal_2766, &Local_2778, &Local_2658, &cLocal_2862, &iLocal_2835, iLocal_2829, bLocal_2711, &iLocal_2717, iLocal_2704, bLocal_2695, bLocal_503, iLocal_2940, 1);
		if (bLocal_509)
		{
		...
		switch (iLocal_2774)
		{
			case 0:
				if (iLocal_2940 > 2 && iLocal_2940 < 15)
				{
					...
					{
						if (!func_487(&uLocal_2947, Local_2778[0 /*20*/].f_6, iLocal_2933, &uLocal_2824, &uLocal_2825, bLocal_2701))
						{
							iLocal_2884 = 15;
							func_486();
						}
					...
					if (bLocal_2741)
					{
						func_485(&uLocal_2948, iLocal_2933, &uLocal_2827, &uLocal_2828, bLocal_2701);
					}
				}
				if (bLocal_2712)
				{
					if (iLocal_2940 >= 7)
					{
						if (!bLocal_503)
						{
							func_480(iLocal_2933, Local_2778[0 /*20*/].f_6, Local_2799, &(Local_2778[0 /*20*/].f_8), &Local_2658, &cLocal_2862, &Local_479, bLocal_2712, &iLocal_2765);
						}
					}
				}
				bLocal_2703 = false;
				...
				{
					func_458(&(Local_1912[func_500() /*28*/]), &(Local_1912[func_500() /*28*/].f_10), Local_692[iLocal_2646 /*23*/].f_1, &(Local_2778[0 /*20*/]), &(Local_2778[0 /*20*/].f_2), &uLocal_2771, fLocal_2860, cLocal_2652, &sLocal_2653, iLocal_2834);
				}
				if (iLocal_462 == 4)
				{
					func_456(&uLocal_2941, iLocal_2934, iLocal_2935, iLocal_2933, &(Local_2778[0 /*20*/].f_2), iLocal_2834, cLocal_2652, &sLocal_2653, &iLocal_2765, bLocal_2701, &(Local_2778[0 /*20*/].f_6));
				}
				if (bLocal_484 && !bLocal_2715)
				{
					if (func_448(Local_2778[0 /*20*/], Local_2778[0 /*20*/].f_6, &uLocal_454, &iLocal_461, 0, 1, 1, 1, 0))
					{
						GlobalFunc_4935();
						if (!ENTITY::IS_ENTITY_DEAD(Local_2778[0 /*20*/]))
						{
					...
					if (func_448(Local_2778[0 /*20*/].f_1, Local_2778[0 /*20*/].f_6, &uLocal_454, &iLocal_461, 0, 1, 0, 1, 0))
					{
						GlobalFunc_4935();
						if (!ENTITY::IS_ENTITY_DEAD(Local_2778[0 /*20*/].f_1))
						{
...
int func_305(bool bParam0, bool bParam1)//Position - 0x2B7F7
{
	...
	else if (Local_692[iLocal_2646 /*23*/] == 4)
	{
		fLocal_2860 = -1f;
		iLocal_2705 = 1;
		iLocal_2934 = VEHICLE::CREATE_VEHICLE(joaat("ambulance"), Local_1912[func_500() /*28*/].f_23, Local_1912[func_500() /*28*/].f_26, 1, 1);
		...
		if (!GlobalFunc_105(Local_1912[func_500() /*28*/].f_17))
		{
			uLocal_2389 = GlobalFunc_2280(Local_1912[func_500() /*28*/].f_17, Local_1912[func_500() /*28*/].f_20);
		}
...
int func_310(struct<3> Param0, float fParam3, var uParam4, bool bParam5)//Position - 0x2BE24
{
	...
	Local_1912[func_500() /*28*/][0 /*3*/] = { Var0.x, Var0.f_1, (Var0.f_2 + 1f) };
	return 1;
}
...
void func_331()//Position - 0x2C82E
{
	float fVar0;
...
void func_332()//Position - 0x2C9E6
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_374()//Position - 0x2FCF7
{
	int iVar0;
...
void func_419()//Position - 0x34580
{
	int iVar0;
...
void func_424()//Position - 0x34773
{
	int iVar0;
...
void func_425()//Position - 0x347EC
{
...
void func_426(var uParam0, float fParam1, bool bParam2)//Position - 0x34822
{
...
int func_446(bool bParam0)//Position - 0x355F5
{
...
int func_448(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8)//Position - 0x35630
{
	int iVar0;
	bool bVar1;
	...
	if (!ENTITY::IS_ENTITY_DEAD(iVar0) && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		if (bParam4)
		{
			if (func_449(iParam0, iParam1, 1, bParam6, bVar1, 1))
			{
				*iParam3 = 32;
				return 1;
			}
		...
		{
			if (func_449(iParam0, iParam1, 0, bParam6, bVar1, bParam8))
			{
				*iParam3 = 16;
				return 1;
			}
...
int func_449(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)//Position - 0x35758
{
	int iVar0;
	int iVar1;
...
void func_456(var uParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5, char* sParam6, var uParam7, var uParam8, bool bParam9, var uParam10)//Position - 0x35CA0
{
	int iVar0;
	...
	while (iVar0 < iParam5)
	{
		if (ENTITY::DOES_ENTITY_EXIST((*uParam4)[iVar0]))
		{
			...
			{
				if (func_448((*uParam4)[iVar0], 0, &uLocal_454, &iLocal_461, 0, 1, 0, 1, 1))
				{
	...
	switch (*uParam0)
	{
		...
		case 3:
			if (!GlobalFunc_105(Local_1912[func_500() /*28*/].f_17))
			{
				GlobalFunc_2275(uLocal_2389, Local_1912[func_500() /*28*/].f_17, Local_1912[func_500() /*28*/].f_20);
			}
			if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tonya5")) == 1)
			{
				if (!iLocal_499)
...
int func_458(var uParam0, var uParam1, struct<3> Param2, var uParam5, var uParam6, var uParam7, float fParam8, char* sParam9, var uParam10, int iParam11)//Position - 0x35FF8
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void func_460(var uParam0)//Position - 0x3625D
{
	int iVar0;
...
int func_462()//Position - 0x363B9
{
	...
	switch (iLocal_2945)
	{
		...
		case 4:
			if ((iLocal_2944 == 8 && bLocal_510) || func_463())
			{
...
int func_469(int iParam0)//Position - 0x37026
{
	float fVar0;
...
void func_470()//Position - 0x370AA
{
	if (!ENTITY::IS_ENTITY_DEAD(Local_2778[0 /*20*/].f_7) && !ENTITY::IS_ENTITY_DEAD(Local_2778[0 /*20*/].f_6))
	{
		if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(Local_2778[0 /*20*/].f_7, Local_2778[0 /*20*/].f_6))
...
int func_471()//Position - 0x37137
{
	switch (iLocal_2943)
	{
						...
						else
						{
							if (!ENTITY::IS_ENTITY_DEAD(Local_2778[0 /*20*/]))
							{
								...
								if (ENTITY::DOES_ENTITY_EXIST(Local_2778[0 /*20*/]))
								{
									...
									func_476(Local_2778[0 /*20*/], uLocal_2767, 1);
								}
								bLocal_2715 = true;
							}
		...
		case 2:
			if (!ENTITY::IS_ENTITY_DEAD(Local_2778[0 /*20*/]))
			{
				if (!PED::IS_PED_IN_ANY_VEHICLE(Local_2778[0 /*20*/], 0))
				{
					...
					{
						if (func_474() || !VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_2933, Local_2778[0 /*20*/].f_6))
						{
							GlobalFunc_4935();
							iLocal_2943 = 5;
						}
		...
		case 4:
			...
			GlobalFunc_173(&Local_2390, iLocal_2838, Local_2778[0 /*20*/], sLocal_2657, 0, 1);
			bLocal_2710 = true;
			func_473(Local_2390, "TOWAUD", sLocal_2651, 0);
			SYSTEM::SETTIMERA(0);
			if (bLocal_2715)
			{
				GlobalFunc_6877(&uLocal_2897);
...
void func_472(bool bParam0)//Position - 0x3795B
{
	int iVar0;
	float fVar1;
...
void func_473(struct<165> Param0, char* sParam165, char* sParam166, bool bParam167)//Position - 0x37AE1
{
	if (bParam167)
	{
		AUDIO::STOP_SCRIPTED_CONVERSATION(0);
...
int func_476(int iParam0, var uParam1, int iParam2)//Position - 0x37C8B
{
	int iVar0;
...
int func_480(int iParam0, int iParam1, struct<7> Param2, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, char* sParam24, var uParam25, bool bParam26, var uParam27)//Position - 0x37D9B
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	...
	if (iLocal_2643 != 12)
	{
		func_484(Param2, iParam0, iParam1);
	}
	if (!bLocal_509)
	{
...
void func_481()//Position - 0x38373
{
	switch (iLocal_518)
	{
		case 0:
...
void func_482()//Position - 0x38450
{
	if (!iLocal_501)
	{
		if (!HUD::IS_MESSAGE_BEING_DISPLAYED())
...
void func_484(struct<7> Param0, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, int iParam20, int iParam21)//Position - 0x3849F
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_485(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)//Position - 0x3856D
{
	int iVar0;
...
void func_486()//Position - 0x38741
{
	if (iLocal_2940 < 16)
	{
		switch (iLocal_2884)
...
int func_487(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5)//Position - 0x38909
{
	int iVar0;
...
void func_495(int iParam0, var uParam1, var uParam2, var uParam3, char* sParam4, var uParam5, int iParam6, bool bParam7, var uParam8, bool bParam9, var uParam10, bool bParam11, int iParam12, bool bParam13)//Position - 0x38C20
{
	int iVar0;
...
void func_499()//Position - 0x390E9
{
	switch (iLocal_462)
	{
		case 2:
...
int func_500()//Position - 0x39172
{
	return Local_692[iLocal_2646 /*23*/].f_22;
}


int func_502(float fParam0, int iParam1, int iParam2)//Position - 0x3921F
{
	float fVar0;
	int iVar1;
	float fVar2;
...
void func_504()//Position - 0x39305
{
...
void func_507()//Position - 0x3AFE1
{
...
void func_510()//Position - 0x3B36D
{
...
void func_511()//Position - 0x3B3F6
{
	if (CAM::IS_SCREEN_FADED_OUT())
	{
		AUDIO::STOP_SCRIPTED_CONVERSATION(0);
		...
		HUD::CLEAR_HELP(1);
		GlobalFunc_553(838);
		MISC::CLEAR_AREA(Local_3341, 8f, 1, 0, 0, 0);
...
void func_514()//Position - 0x3B53B
{
	if (CAM::IS_SCREEN_FADED_OUT())
	{
		func_515();
...
void func_515()//Position - 0x3B58E
{
	func_516(405.7806f, -1652.369f, 28.2928f, 139.8366f);
	STREAMING::REQUEST_MODEL(joaat("towtruck"));
...
void func_516(struct<3> Param0, float fParam3)//Position - 0x3B5FD
{
	int iVar0;
...
int func_517(struct<3> Param0, float fParam3)//Position - 0x3B69C
{
	return func_518(&(Global_93588.f_2167), Param0, fParam3, 0);
}

int func_518(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x3B6B6
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
	...
	if (GlobalFunc_6794(uParam0))
	{
		...
		if (GlobalFunc_7696(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				func_528(iVar0, &(uParam0->f_12), 0, 1);
				bVar4 = true;
...
void func_528(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x3BFEA
{
	int iVar0;
...
void func_540()//Position - 0x3C750
{
	if (CAM::IS_SCREEN_FADED_OUT())
	{
		func_541();
...
void func_541()//Position - 0x3C787
{
	func_516(Local_2573, fLocal_2576);
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID()))
	{
		if (!GlobalFunc_188())
		{
			ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), Local_3341, 1, 0, 0, 1);
			ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), fLocal_3344);
		}
...
void func_545(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, int iParam7)//Position - 0x3C8BD
{
	uParam1 = uParam1;
	if (!bLocal_503)
	{
...
void func_551(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x3CD4B
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_567(var uParam0)//Position - 0x3D77F
{
	int iVar0;
...
void func_568(var uParam0)//Position - 0x3D80D
{
	func_569(uParam0, &(uParam0->f_2), uParam0->f_1);
}

void func_569(var uParam0, char* sParam1, int iParam2)//Position - 0x3D823
{
...
void func_573()//Position - 0x3D955
{
	GlobalFunc_53();
	PATHFIND::SET_ROADS_BACK_TO_ORIGINAL_IN_ANGLED_AREA(-537.0874f, 129.9377f, 60.97144f, -397.5062f, 126.5231f, 69.54237f, 30f, 1);
	if (GlobalFunc_9574())
	{
	}
	func_575(&Local_2981, 1, 0, 0);
...
void func_575(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x3DA0D
{
...
void func_580(var uParam0, bool bParam1)//Position - 0x3DAE3
{
	func_581(&(uParam0->f_35), bParam1);
}

void func_581(var uParam0, bool bParam1)//Position - 0x3DAF5
{
	int iVar0;
...
void func_582(int iParam0)//Position - 0x3DB32
{
...
void func_590(var uParam0, bool bParam1)//Position - 0x3DD9A
{
	int iVar0;
