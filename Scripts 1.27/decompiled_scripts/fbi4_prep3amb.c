...
int func_154()//Position - 0x7A9C
{
	if (MISC::IS_BIT_SET(uLocal_104, 0))
	{
		if (GlobalFunc_5201(iLocal_108))
		{
			if (MISC::IS_BIT_SET(uLocal_104, 1))
			{
				if ((GlobalFunc_791(0) || GlobalFunc_791(2)) || GlobalFunc_791(1))
				{
					func_1(46, 1);
					func_155();
					return 1;
						...
						if (!MISC::IS_BIT_SET(uLocal_104, 7))
						{
							...
							if (GlobalFunc_5201(iVar0))
							{
								if (!GlobalFunc_797(iVar0))
								{
									...
									{
										if (func_194(iVar0) && !GlobalFunc_796())
										{
...
{
	if (((((Global_34913 == 15 && !GlobalFunc_487()) && Global_68242 == -1) && !GlobalFunc_784()) && !func_223(1112014848)) && !Global_96408)
	{
		return 1;
	}
	return 0;
