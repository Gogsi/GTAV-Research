...
void func_310()//Position - 0x4974E
{
	...
	if (iLocal_77 == 0)
	{
		...
		GlobalFunc_11089(4, "STAGE_DRIVE_TO_WAREHOUSE", 1, 0, 0, 1);
		iLocal_433 = 0;
		iLocal_437 = 0;
		iLocal_430 = 0;
		iLocal_431 = 1;
...
void func_437()//Position - 0x56C58
{
	...
	if (iLocal_77 == 0)
	{
		...
		GlobalFunc_11089(3, "STAGE_CHECK_ROOF", 0, 0, 0, 1);
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_200, 0))
		{
			ENTITY::FREEZE_ENTITY_POSITION(iLocal_200, 0);
		}
...
void func_461()//Position - 0x5A50D
{
	...
	if (iLocal_77 == 0)
	{
		...
		GlobalFunc_11089(2, "STAGE_FIND_ROOF_ENTRANCE", 0, 0, 0, 1);
		iLocal_504 = 0;
		iLocal_464 = 0;
		iLocal_455 = 0;
		iLocal_487 = 0;
...
void func_462()//Position - 0x5AB27
{
	...
	if (iLocal_77 == 0)
	{
		GlobalFunc_11089(1, "STAGE_SCOUT_OUT_STORE", 0, 0, 0, 1);
		if (iLocal_434 == 1)
		{
			func_394();
			iLocal_434 = 0;
