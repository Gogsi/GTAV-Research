...
void func_241(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x265E2
{
	...
	func_242(Global_SAVE_DATA.CHARSHEET_SAVED_ARRAY[iParam0 /*29*/].f_17, 1, iParam1, iParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
void func_245(int iParam0)//Position - 0x26FA4
{
	...
	else if (MISC::IS_BIT_SET(Global_SAVE_DATA.FINANCE_SAVED_ARRAY.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_247() /*8053*/].f_5756.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_SAVE_DATA.FINANCE_SAVED_ARRAY.f_471), iParam0);
...
void func_326(int iParam0, bool bParam1)//Position - 0x2B2C1
{
	...
	if (func_150(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_327(iParam0, &(Global_SAVE_DATA.COMPONENTS_ARRAY.PP_INFO_STRUCT.f_298[iVar0 /*284*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
int func_359(int iParam0)//Position - 0x2DD6A
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_360(Global_SAVE_DATA.FLOW_STRUCT.MF_CONTROLS_STRUCT.f_203[10]);
			break;
		
		case 74:
		case 75:
			return func_360(Global_SAVE_DATA.FLOW_STRUCT.MF_CONTROLS_STRUCT.f_203[8]);
			break;
		
		case 84:
		case 85:
			return func_360(Global_SAVE_DATA.FLOW_STRUCT.MF_CONTROLS_STRUCT.f_203[11]);
			break;
		
		case 90:
			return func_360(Global_SAVE_DATA.FLOW_STRUCT.MF_CONTROLS_STRUCT.f_203[7]);
			break;
		
		case 93:
			return func_360(Global_SAVE_DATA.FLOW_STRUCT.MF_CONTROLS_STRUCT.f_203[9]);
			break;
	}
	return 0;
}
...
void func_409(int iParam0, int iParam1, int iParam2)//Position - 0x2FA92
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_SAVE_DATA.VEHICLE_GEN_SAVED_DATA_STRUCT.f_4249 = func_347();
			}
...
void func_410(int iParam0, int iParam1)//Position - 0x2FBAF
{
	...
	func_315(iParam0, &(Global_SAVE_DATA.VEHICLE_GEN_SAVED_DATA_STRUCT.f_4742));
}
...
int func_423(var uParam0, int iParam1)//Position - 0x305CA
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_336(Global_SAVE_DATA.VEHICLE_GEN_SAVED_DATA_STRUCT.f_1312[uParam0->f_14 /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_336(Global_SAVE_DATA.COMPONENTS_ARRAY.PP_INFO_STRUCT.f_2528[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_336(Global_SAVE_DATA.COMPONENTS_ARRAY.PP_INFO_STRUCT.f_2528[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f))
		{
...
void func_424(int iParam0, struct<54> Param1, struct<3> Param55, float fParam58, int iParam59)//Position - 0x31CBE
{
	if (func_423(&(Global_67138.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_426(iParam0);
			func_425(Param1, &(Global_SAVE_DATA.VEHICLE_GEN_SAVED_DATA_STRUCT.f_69[Global_67138.f_555[0 /*21*/].f_14 /*54*/]));
