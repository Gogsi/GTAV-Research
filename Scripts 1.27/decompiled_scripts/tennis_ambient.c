...
void func_324()//Position - 0x10148
{
	...
	if (Global_SAVE_DATA.isGameflowActive || func_333(0))
	{
		if (!func_332())
		{
			iVar0 = func_331();
...
int func_326(int iParam0)//Position - 0x102A8
{
	...
	func_327(&(Global_SAVE_DATA.COMPONENTS_ARRAY.PP_INFO_STRUCT), iVar1);
...
void func_327(var uParam0, int iParam1)//Position - 0x103BF
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_329(Global_SAVE_DATA.PLAYER_SCENE_SAVED_DATA[iVar0], &Var2, &fVar5))
			{
