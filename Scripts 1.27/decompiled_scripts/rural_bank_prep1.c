...
void func_4(bool bParam0, int iParam1)//Position - 0x32C
{
	...
	if (Global_SAVE_DATA.isGameflowActive || func_7(0))
	{
		iVar0 = func_5();
...
void func_84(int iParam0, int iParam1)//Position - 0x3F63
{
	...
	func_85(iParam0, &(Global_SAVE_DATA.VEHICLE_GEN_SAVED_DATA_STRUCT.f_4742));
}
...
void func_109(int iParam0, int iParam1, int iParam2)//Position - 0x51DE
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_SAVE_DATA.VEHICLE_GEN_SAVED_DATA_STRUCT.f_4249 = func_110();
			}
...
int func_121(var uParam0, int iParam1)//Position - 0x55E7
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_130(Global_SAVE_DATA.VEHICLE_GEN_SAVED_DATA_STRUCT.f_1312[uParam0->f_14 /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_130(Global_SAVE_DATA.COMPONENTS_ARRAY.PP_INFO_STRUCT.f_2528[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_130(Global_SAVE_DATA.COMPONENTS_ARRAY.PP_INFO_STRUCT.f_2528[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f))
		{
...
void func_124(int iParam0, struct<54> Param1, struct<3> Param55, var uParam58, int iParam59)//Position - 0x6F95
{
	if (func_121(&(Global_67138.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_129(iParam0);
			func_128(Param1, &(Global_SAVE_DATA.VEHICLE_GEN_SAVED_DATA_STRUCT.f_69[Global_67138.f_555[0 /*21*/].f_14 /*54*/]));
...
int func_186(int iParam0)//Position - 0xC737
{
	...
	func_187(&(Global_SAVE_DATA.COMPONENTS_ARRAY.PP_INFO_STRUCT), iVar1);
...
void func_187(var uParam0, int iParam1)//Position - 0xC84E
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_189(Global_SAVE_DATA.PLAYER_SCENE_SAVED_DATA[iVar0], &Var2, &fVar5))
			{
