...
void __EntryFunction__()//Position - 0x0
{
	...
	if (GlobalFunc_Is_Mission_Retry())
	{
		...
		GlobalFunc_10698(&iVar0, 236.1378f, -369.3902f, 43.2497f, 251.2f, 0, 0, 0, 1, 0, joaat("asterope"), 0, 145);
		Global_68490 = 0;
	}
	while (true)
	{
...
void func_1()//Position - 0x11D
{
	switch (iLocal_81)
	{
		...
		case 1:
			...
			GlobalFunc_173(&uLocal_144, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
			GlobalFunc_173(&uLocal_144, 3, 0, "BARRY", 0, 1);
			iLocal_143 = 0;
			iLocal_81 = 2;
			break;
