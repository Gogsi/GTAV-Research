	...
	switch (iLocal_260)
	{
		...
		case 2:
			if (!ENTITY::IS_ENTITY_DEAD(uLocal_309[0]) && !HUD::DOES_BLIP_EXIST(uLocal_307))
			{
				...
				GlobalFunc_11061(3, "STAGE_FLY_AWAY_WITH_CARRIAGE", 0, 0, 0, 1);
...
void func_217()//Position - 0xED3F
{
	...
	{
		case 0:
			GlobalFunc_11061(2, "STAGE_WAIT_FOR_TRAIN_TO_STOP_IN_SIDING", 0, 0, 0, 1);
			if (func_211())
			{
...
void func_585()//Position - 0x6034B
{
	switch (iLocal_260)
	{
		case 0:
			...
			GlobalFunc_11061(1, "STAGE_WAIT_FOR_TRAIN", 0, 0, 0, 1);
			if (func_211())
			{
				Global_89962.f_12[0] = 0;
			}
