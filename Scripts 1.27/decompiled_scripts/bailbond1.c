		...
		switch (iLocal_97)
		{
			...
			case 2:
				...
				if (iLocal_110 == 3)
				{
					if (iLocal_99 == 0)
					{
						if (GlobalFunc_4924(Local_111.f_9) && GlobalFunc_4947(Local_247[0 /*6*/]))
						{
		...
		case 1:
			...
			else
			{
				...
				if (iLocal_101 == 4)
				{
					...
					else if (GlobalFunc_4924(Local_335))
					{
...
void func_89(bool bParam0)//Position - 0x24F1
{
	...
	if (iLocal_419 > 0)
	{
		...
		while (iVar0 <= (iLocal_419 - 1))
		{
			if (iLocal_110 == 4)
			{
				if (GlobalFunc_4924(Local_132[iVar0 /*19*/]))
				{
...
{
	if (GlobalFunc_4924(Local_132[iParam0 /*19*/]))
	{
...
int func_462()//Position - 0x2EFFE
{
	...
	if (iLocal_419 > 0)
	{
		...
		while (iVar2 <= (iLocal_419 - 1))
		{
			...
			{
				if (GlobalFunc_4924(Local_132[iVar2 /*19*/]))
				{
					iVar0++;
					iVar1++;
				}
