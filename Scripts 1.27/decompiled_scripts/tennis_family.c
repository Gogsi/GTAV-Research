...
void func_328()//Position - 0x10549
{
	...
	if (Global_SAVE_DATA.isGameflowActive || func_337(0))
	{
		if (!func_336())
		{
			iVar0 = func_335();
...
int func_330(int iParam0)//Position - 0x106A9
{
	...
	func_331(&(Global_SAVE_DATA.COMPONENTS_ARRAY.PP_INFO_STRUCT), iVar1);
...
void func_331(var uParam0, int iParam1)//Position - 0x107C0
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar5 = 0f;
			if (!func_333(Global_SAVE_DATA.PLAYER_SCENE_SAVED_DATA[iVar0], &Var2, &fVar5))
			{
