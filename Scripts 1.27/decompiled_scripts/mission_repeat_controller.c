...
void func_67(int iParam0)//Position - 0x1F7E
{
	...
	if (Global_Mission_Fail_State != 12)
	{
		...
		func_95(&cVar9, iVar8, Global_Current_Checkpoint, 1, 0);
...
var func_98(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x4294
{
	...
	if (!bParam4)
	{
		...
		func_95(&cVar1, iVar0, Global_Current_Checkpoint, 0, 0);
...
void func_517(int iParam0, int iParam1, bool bParam2)//Position - 0x5BD06
{
	if (bParam2)
	{
		if (GlobalFunc_6687(0))
		{
			func_536(Global_Running_Missions[iParam1 /*5*/].f_2);
		}
		else
		{
	...
	{
		GlobalFunc_1997(&(Global_Running_Missions[iParam1 /*5*/].f_3));
	}
	GlobalFunc_8306();
