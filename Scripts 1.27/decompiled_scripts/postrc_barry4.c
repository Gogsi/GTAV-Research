...
{
	if ((MISC::GET_GAME_TIMER() - iLocal_201) > 5000)
	{
...
bool func_2(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xD4
{
...
int func_3(char* sParam0, int iParam1, bool bParam2)//Position - 0x122
{
	Global_15693 = 0;
...
bool func_11(int iParam0)//Position - 0x72B
{
	return iParam0 < 3;
}

int func_12(var uParam0)//Position - 0x737
{
	int iVar0;
	int iVar1;
...
int func_13(int iParam0)//Position - 0x774
{
	if (func_11(iParam0))
	{
...
bool func_14(int iParam0)//Position - 0x79E
{
	return Global_34913 == iParam0;
}

void func_15()//Position - 0x7AC
{
	int iVar0;
...
bool func_16(int iParam0, int iParam1)//Position - 0x803
{
	switch (iParam0)
	{
		case 5:
...
void func_18(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x895
{
...
void func_19()//Position - 0x8EB
{
	iLocal_201 = MISC::GET_GAME_TIMER();
	func_20(&uLocal_36, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	iLocal_35 = 1;
}

void func_20(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x90C
{
...
int func_21(int iParam0)//Position - 0x9A7
{
...
void func_24()//Position - 0xA36
{
	func_25(&uLocal_36, 1);
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_25(var uParam0, int iParam1)//Position - 0xA49
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
