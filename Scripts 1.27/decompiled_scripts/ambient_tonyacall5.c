	...
	switch (iLocal_39)
	{
		...
		case 1:
			if (ENTITY::DOES_ENTITY_EXIST(uLocal_37) && !ENTITY::IS_ENTITY_DEAD(uLocal_37))
			{
				...
				else if (TASK::GET_SEQUENCE_PROGRESS(uLocal_37) == 2)
				{
					...
					if (iVar6 == 0)
					{
						if (GlobalFunc_10643(&uLocal_62, "TOWAUD", "TONYA_CALL5", 8, 0, 0, 0))
						{
							iLocal_39 = 2;
						}
					}
					else if (GlobalFunc_10643(&uLocal_62, "TOWAUD", "TONYA_CALL6", 8, 0, 0, 0))
					{
						iLocal_39 = 2;
					}
				}
		...
		case 3:
			...
			if (SYSTEM::VDIST2(Var0, Var3) < 25f)
			{
				...
				{
					if (GlobalFunc_10643(&uLocal_62, "TOWAUD", "TOW_MESS3", 8, 0, 0, 0))
					{
						SYSTEM::SETTIMERA(0);
						iLocal_39 = 4;
					}
