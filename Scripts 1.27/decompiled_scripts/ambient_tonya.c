	...
	switch (iLocal_79)
	{
		case 0:
			if (!GlobalFunc_890())
			{
				if (GlobalFunc_665(103))
				{
					GlobalFunc_173(&uLocal_80, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
					GlobalFunc_173(&uLocal_80, 3, 0, "TONYA", 0, 1);
...
{
	GlobalFunc_789(uParam0, iParam1, sParam2, iParam6, iParam7, 0);
	Global_15740 = 0;
	Global_15699 = 1;
	Global_15706 = 0;
	Global_15701 = 0;
	...
	Global_2621441 = 0;
	return GlobalFunc_9625(sParam3, iParam4, bParam8);
}
...
int func_158()//Position - 0xA09E
{
	...
	if (GlobalFunc_794(60) && !GlobalFunc_485(104))
	{
		return 0;
	}
	else if (GlobalFunc_794(59) && !GlobalFunc_485(103))
	{
		return 0;
	}
...
{
	if (GlobalFunc_794(61) || GlobalFunc_794(62))
	{
		GlobalFunc_492(28);
	}
	SCRIPT::TERMINATE_THIS_THREAD();
