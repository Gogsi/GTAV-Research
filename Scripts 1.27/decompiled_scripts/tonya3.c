...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_2940 = 1;
	sLocal_3319 = "DEFAULT";
	Local_3331 = { 401.637f, -1633.3f, 28.2928f };
	fLocal_3334 = 231.5304f;
	Local_3335 = { -215.5832f, -1392.783f, 30.2617f };
	fLocal_3338 = 108.4129f;
	Local_3344 = { -10.7897f, -1471.204f, 29.552f };
	fLocal_3347 = 276.1668f;
	...
	PATHFIND::SET_ROADS_IN_ANGLED_AREA(133.4928f, -2596.173f, 0.000145f, 323.7669f, -2513.723f, 11.68388f, 70f, 0, 0, 1);
	uLocal_3342 = VEHICLE::ADD_ROAD_NODE_SPEED_ZONE(344.4851f, -2506.602f, 4.943f, 20f, 3f, 0);
	uLocal_3343 = VEHICLE::ADD_ROAD_NODE_SPEED_ZONE(220.8717f, -2544.95f, 5.2096f, 20f, 0f, 0);
	GlobalFunc_587();
	while (true)
	{
		SYSTEM::WAIT(0);
		func_568(&uLocal_3042);
		RECORDING::_0x208784099002BC30("RC_TON3", 0);
		func_552(Local_2981.f_9, 0, 0, 0, 0, 0);
		...
		if (!iLocal_3339)
		{
			if (GlobalFunc_199())
			{
				...
				if (!Global_84544)
				{
					if (iLocal_3341 == 0)
					{
						GlobalFunc_5116(Local_3344, fLocal_3347, 1, 0);
					}
					else if (iLocal_3341 == 1)
					{
						GlobalFunc_5116(404.1494f, -1630.793f, 28.2928f, 231.5304f, 1, 0);
					}
					else if (iLocal_3341 == 2)
					{
						GlobalFunc_5116(Local_3335, fLocal_3338, 1, 0);
					}
				}
				else if (iLocal_3341 == 0)
				{
					GlobalFunc_5116(404.1494f, -1630.793f, 28.2928f, 231.5304f, 1, 0);
				}
				else if (iLocal_3341 == 1)
				...
				if (GlobalFunc_747(Global_SAVE_DATA.TOWING_SAVED_STRUCT.TOWING_iBools, 4194304))
				{
					if (Global_SAVE_DATA.TOWING_SAVED_STRUCT.TOWING_iLastNodeIndex == -1)
					{
						iLocal_2646 = 51;
					}
					else
					{
						iLocal_2646 = Global_SAVE_DATA.TOWING_SAVED_STRUCT.TOWING_iLastNodeIndex;
					}
				}
				iLocal_3339 = 1;
			}
			...
			{
				if (GlobalFunc_5683(217.386f, -2545.061f, 5.1932f, 1) < 150f)
				{
					iLocal_2646 = 28;
					Global_SAVE_DATA.TOWING_SAVED_STRUCT.TOWING_iLastNodeIndex = iLocal_2646;
					GlobalFunc_5211(&(Global_SAVE_DATA.TOWING_SAVED_STRUCT.TOWING_iBools), 4194304);
				}
				iLocal_3339 = 1;
			}
		}
		uLocal_116 = uLocal_116;
		uLocal_2745 = uLocal_2745;
...
void func_5()//Position - 0x61E
{
	GlobalFunc_11330(210, 1);
	func_574();
}
...
int func_202(var uParam0, var uParam1)//Position - 0x24D9B
{
	...
	if (uParam0->f_6)
	{
		...
		switch (uParam0->f_2)
		{
			case 1:
				if (uParam0->f_4)
				{
					...
					{
						iLocal_2646 = func_498(100000f, iLocal_462, Global_SAVE_DATA.TOWING_SAVED_STRUCT.TOWING_iLastNodeIndex);
					}
				}
				else
				{
		...
		{
			iLocal_2834 = Local_1912[func_496() /*28*/].f_27;
		}
		func_495();
		bLocal_2701 = false;
	...
	{
		func_491(&iLocal_2933, &uLocal_2766, &Local_2778, &Local_2658, &cLocal_2862, &iLocal_2835, iLocal_2829, bLocal_2711, &iLocal_2717, iLocal_2704, bLocal_2695, bLocal_503, iLocal_2940, 1);
		if (bLocal_509)
		{
		...
		switch (iLocal_2774)
		{
			case 0:
				if (iLocal_2940 > 2 && iLocal_2940 < 15)
				{
					...
					{
						if (!func_483(&uLocal_2947, Local_2778[0 /*20*/].f_6, iLocal_2933, &uLocal_2824, &uLocal_2825, bLocal_2701))
						{
							iLocal_2884 = 15;
							func_482();
						}
					...
					if (bLocal_2741)
					{
						func_481(&uLocal_2948, iLocal_2933, &uLocal_2827, &uLocal_2828, bLocal_2701);
					}
				}
				if (bLocal_2712)
				{
					if (iLocal_2940 >= 7)
					{
						if (!bLocal_503)
						{
							func_476(iLocal_2933, Local_2778[0 /*20*/].f_6, Local_2799, &(Local_2778[0 /*20*/].f_8), &Local_2658, &cLocal_2862, &Local_479, bLocal_2712, &iLocal_2765);
						}
					}
				}
				bLocal_2703 = false;
				...
				{
					func_453(&(Local_1912[func_496() /*28*/]), &(Local_1912[func_496() /*28*/].f_10), Local_692[iLocal_2646 /*23*/].f_1, &(Local_2778[0 /*20*/]), &(Local_2778[0 /*20*/].f_2), &uLocal_2771, fLocal_2860, cLocal_2652, &sLocal_2653, iLocal_2834);
				}
				if (iLocal_462 == 4)
				{
					func_451(&uLocal_2941, iLocal_2934, iLocal_2935, iLocal_2933, &(Local_2778[0 /*20*/].f_2), iLocal_2834, cLocal_2652, &sLocal_2653, &iLocal_2765, bLocal_2701, &(Local_2778[0 /*20*/].f_6));
				}
				if (bLocal_484 && !bLocal_2715)
				{
					if (func_444(Local_2778[0 /*20*/], Local_2778[0 /*20*/].f_6, &uLocal_454, &iLocal_461, 0, 1, 1, 1, 0))
					{
						GlobalFunc_4935();
						if (!ENTITY::IS_ENTITY_DEAD(Local_2778[0 /*20*/]))
						{
					...
					if (func_444(Local_2778[0 /*20*/].f_1, Local_2778[0 /*20*/].f_6, &uLocal_454, &iLocal_461, 0, 1, 0, 1, 0))
					{
						GlobalFunc_4935();
						if (!ENTITY::IS_ENTITY_DEAD(Local_2778[0 /*20*/].f_1))
						{
				...
				func_422(&uLocal_2894, 7f, 1);
				func_421();
				func_420();
				if ((!bLocal_509 || iLocal_2940 >= 15) || uLocal_2700)
				{
					if (func_238(*uParam0, uParam1))
					{
						return 1;
					}
				}
				...
				if (iLocal_462 == 1)
				{
					if (iLocal_2940 == 9)
					{
						func_216(Local_2390, &Local_2778, &iLocal_2933);
					}
				}
				else if (iLocal_462 == 3)
				{
...
int func_203(struct<3> Param0, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8)//Position - 0x25682
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_2933))
	{
		if (!VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_2933, 0) || func_214())
		{
			iLocal_2884 = 2;
			return 1;
		}
...
void func_216(struct<165> Param0, int iParam165, int iParam166)//Position - 0x25CB5
{
	if (!iLocal_505)
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID()))
		{
			if (iLocal_2647 > 1)
			{
				if (func_236(iParam165, iParam166))
				{
					if (GlobalFunc_111())
					{
...
int func_229(var uParam0)//Position - 0x2664C
{
	switch (iLocal_2648)
	{
		case 1:
...
void func_233(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, var uParam43, var uParam44, var uParam45, var uParam46, var uParam47, var uParam48, var uParam49, var uParam50, var uParam51, var uParam52, var uParam53, var uParam54, var uParam55, var uParam56, var uParam57, var uParam58, var uParam59, var uParam60, var uParam61, var uParam62, var uParam63, var uParam64, var uParam65, var uParam66, var uParam67, var uParam68, var uParam69, var uParam70, var uParam71, var uParam72, var uParam73, var uParam74, var uParam75, var uParam76, var uParam77, var uParam78, var uParam79, var uParam80, var uParam81, var uParam82, var uParam83, var uParam84, var uParam85, var uParam86, var uParam87, var uParam88, var uParam89, var uParam90, var uParam91, var uParam92, var uParam93, var uParam94, var uParam95, var uParam96, var uParam97, var uParam98, var uParam99, var uParam100, var uParam101, var uParam102, var uParam103, var uParam104, var uParam105, var uParam106, var uParam107, var uParam108, var uParam109, var uParam110, var uParam111, var uParam112, var uParam113, var uParam114, var uParam115, var uParam116, var uParam117, var uParam118, var uParam119, var uParam120, var uParam121, var uParam122, var uParam123, var uParam124, var uParam125, var uParam126, var uParam127, var uParam128, var uParam129, var uParam130, var uParam131, var uParam132, var uParam133, var uParam134, var uParam135, var uParam136, var uParam137, var uParam138, var uParam139, var uParam140, var uParam141, var uParam142, var uParam143, var uParam144, var uParam145, var uParam146, var uParam147, var uParam148, var uParam149, var uParam150, var uParam151, var uParam152, var uParam153, var uParam154, var uParam155, var uParam156, var uParam157, var uParam158, var uParam159, var uParam160, var uParam161, var uParam162, var uParam163, var uParam164, var uParam165)//Position - 0x26EF4
{
	int iVar0;
...
void func_234(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, var uParam43, var uParam44, var uParam45, var uParam46, var uParam47, var uParam48, var uParam49, var uParam50, var uParam51, var uParam52, var uParam53, var uParam54, var uParam55, var uParam56, var uParam57, var uParam58, var uParam59, var uParam60, var uParam61, var uParam62, var uParam63, var uParam64, var uParam65, var uParam66, var uParam67, var uParam68, var uParam69, var uParam70, var uParam71, var uParam72, var uParam73, var uParam74, var uParam75, var uParam76, var uParam77, var uParam78, var uParam79, var uParam80, var uParam81, var uParam82, var uParam83, var uParam84, var uParam85, var uParam86, var uParam87, var uParam88, var uParam89, var uParam90, var uParam91, var uParam92, var uParam93, var uParam94, var uParam95, var uParam96, var uParam97, var uParam98, var uParam99, var uParam100, var uParam101, var uParam102, var uParam103, var uParam104, var uParam105, var uParam106, var uParam107, var uParam108, var uParam109, var uParam110, var uParam111, var uParam112, var uParam113, var uParam114, var uParam115, var uParam116, var uParam117, var uParam118, var uParam119, var uParam120, var uParam121, var uParam122, var uParam123, var uParam124, var uParam125, var uParam126, var uParam127, var uParam128, var uParam129, var uParam130, var uParam131, var uParam132, var uParam133, var uParam134, var uParam135, var uParam136, var uParam137, var uParam138, var uParam139, var uParam140, var uParam141, var uParam142, var uParam143, var uParam144, var uParam145, var uParam146, var uParam147, var uParam148, var uParam149, var uParam150, var uParam151, var uParam152, var uParam153, var uParam154, var uParam155, var uParam156, var uParam157, var uParam158, var uParam159, var uParam160, var uParam161, var uParam162, var uParam163, var uParam164, var uParam165)//Position - 0x26FDA
{
...
int func_236(var uParam0, var uParam1)//Position - 0x2702C
{
	if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
	{
...
void func_237()//Position - 0x2714F
{
	if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tonya3")) == 1 || SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tonya4")) == 1)
	{
		return;
...
int func_238(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9)//Position - 0x271E2
{
	var uVar0;
	char* sVar1;
	var uVar2;
	...
	switch (iLocal_2940)
	{
		...
		case 4:
			...
			{
				case 3:
					if (func_302("TOWT_OBJ_01", "TOWT_HELP_01", &uVar0, 1, 0))
					{
						if (!ENTITY::IS_ENTITY_DEAD(Local_2778[0 /*20*/].f_6))
						{
				...
				case 2:
					if (func_302("TOWT_OBJ_AB", "TOWT_HELP_AB", &uVar0, 0, 0))
					{
				...
				case 0:
					if (func_302("TOWT_OBJ_01B", "TOWT_HELP_03", &uVar0, 0, 0))
					{
				...
				case 1:
					if (func_302("TOWT_OBJ_TR", "TOWT_HELP_TR", &uVar0, 0, 1))
					{
						VEHICLE::SET_VEHICLE_UNDRIVEABLE(Local_2778[0 /*20*/].f_6, 1);
				...
				case 4:
					if (func_302("TOWT_OBJ_CC", "TOWT_HELP_04", &uVar0, 0, 0))
					{
						VEHICLE::SET_VEHICLE_UNDRIVEABLE(Local_2778[0 /*20*/].f_6, 1);
						func_300();
						iLocal_2940 = 6;
		...
		case 5:
			if (func_292(&iLocal_2942, 0, "TOW_BREAK1"))
			{
				iLocal_2940 = 7;
			}
			break;
		...
		case 7:
			...
			else if (iLocal_2734 && !iLocal_2726)
			{
				if (bLocal_2712)
				{
					if (!func_288(&uVar2, &uVar5, &uVar11))
					{
				...
				else if (!func_288(&uVar2, &uVar5, &uVar11))
				{
...
void func_264()//Position - 0x28E2D
{
...
void func_271()//Position - 0x292D9
{
...
int func_273(char* sParam0)//Position - 0x2948E
{
	var uVar0;
	var uVar3;
	var uVar6;
...
void func_275()//Position - 0x29A63
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_276()//Position - 0x29C0D
{
	if (!iLocal_2737)
	{
		if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tonya2")) == 1)
...
void func_277()//Position - 0x29CE9
{
	struct<3> Var0;
...
void func_278()//Position - 0x29F5F
{
	struct<3> Var0;
	int iVar3;
...
int func_279(char* sParam0, struct<3> Param1)//Position - 0x2A172
{
	bool bVar0;
	int iVar1;
...
void func_280(var uParam0)//Position - 0x2A352
{
...
void func_286()//Position - 0x2A40E
{
	if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tonya2")) == 1)
	{
...
void func_287()//Position - 0x2A4B6
{
	int iVar0;
	struct<3> Var1;
	struct<3> Var4;
...
int func_288(var uParam0, var uParam1, var uParam2)//Position - 0x2A680
{
	if (iLocal_2819 != -1)
	{
...
void func_289()//Position - 0x2A86E
{
...
void func_290(int iParam0, var uParam1)//Position - 0x2A8FF
{
...
void func_291()//Position - 0x2ABDF
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_292(int iParam0, int iParam1, char* sParam2)//Position - 0x2ACAC
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_296(int iParam0)//Position - 0x2B47A
{
	int iVar0;
...
void func_300()//Position - 0x2B61C
{
	int iVar0;
...
int func_302(char* sParam0, char* sParam1, var uParam2, bool bParam3, bool bParam4)//Position - 0x2B6CE
{
	...
	if (bParam3)
	{
		if (func_308(Local_2857, fLocal_2860, uParam2, 0))
		{
...
int func_303(bool bParam0, bool bParam1)//Position - 0x2B7B2
{
	int iVar0;
	
	iVar0 = 0;
	if (!func_305(Local_692[iLocal_2646 /*23*/].f_1, Local_692[iLocal_2646 /*23*/].f_4, &iVar0, 0, bParam1))
	{
		return 0;
	}
	...
	else if (Local_692[iLocal_2646 /*23*/] == 4)
	{
		fLocal_2860 = -1f;
		iLocal_2705 = 1;
		iLocal_2934 = VEHICLE::CREATE_VEHICLE(joaat("ambulance"), Local_1912[func_496() /*28*/].f_23, Local_1912[func_496() /*28*/].f_26, 1, 1);
		...
		if (!GlobalFunc_105(Local_1912[func_496() /*28*/].f_17))
		{
			uLocal_2389 = GlobalFunc_2280(Local_1912[func_496() /*28*/].f_17, Local_1912[func_496() /*28*/].f_20);
		}
...
int func_305(struct<3> Param0, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x2BB19
{
	float fVar0;
	float fVar1;
	float fVar2;
	
	*iParam4 = GlobalFunc_4906(&Local_2778);
	if (*iParam4 == -1)
	{
		return 0;
	}
...
int func_308(struct<3> Param0, float fParam3, var uParam4, bool bParam5)//Position - 0x2BDDF
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
	...
	if (!func_305(Param0, fParam3, uParam4, 1, bParam5))
	{
		return 0;
	}
	if (*uParam4 == -1)
	...
	Local_1912[func_496() /*28*/][0 /*3*/] = { Var0.x, Var0.f_1, (Var0.f_2 + 1f) };
	return 1;
}

int func_309(var uParam0, var uParam1)//Position - 0x2BEF7
{
	func_326();
	func_325();
	if (uParam0->f_3 == 3)
...
void func_325()//Position - 0x2C613
{
	if (iLocal_462 == 2)
	{
...
void func_326()//Position - 0x2C7A5
{
...
void func_327()//Position - 0x2C7C7
{
	float fVar0;
...
void func_328()//Position - 0x2C97F
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_370()//Position - 0x2FC90
{
	int iVar0;
...
void func_415()//Position - 0x34517
{
	int iVar0;
...
void func_420()//Position - 0x3470A
{
	int iVar0;
...
void func_421()//Position - 0x34783
{
...
void func_422(var uParam0, float fParam1, bool bParam2)//Position - 0x347B9
{
...
int func_442(bool bParam0)//Position - 0x3558C
{
...
int func_444(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8)//Position - 0x355C7
{
	int iVar0;
	bool bVar1;
	...
	if (!ENTITY::IS_ENTITY_DEAD(iVar0) && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		if (bParam4)
		{
			if (func_445(iParam0, iParam1, 1, bParam6, bVar1, 1))
			{
				*iParam3 = 32;
				return 1;
			}
		...
		{
			if (func_445(iParam0, iParam1, 0, bParam6, bVar1, bParam8))
			{
				*iParam3 = 16;
				return 1;
			}
...
int func_445(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)//Position - 0x356EF
{
	int iVar0;
	int iVar1;
...
void func_451(var uParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5, char* sParam6, var uParam7, var uParam8, bool bParam9, var uParam10)//Position - 0x35C28
{
	int iVar0;
	...
	while (iVar0 < iParam5)
	{
		if (ENTITY::DOES_ENTITY_EXIST((*uParam4)[iVar0]))
		{
			...
			{
				if (func_444((*uParam4)[iVar0], 0, &uLocal_454, &iLocal_461, 0, 1, 0, 1, 1))
				{
	...
	switch (*uParam0)
	{
		...
		case 3:
			if (!GlobalFunc_105(Local_1912[func_496() /*28*/].f_17))
			{
				GlobalFunc_2275(uLocal_2389, Local_1912[func_496() /*28*/].f_17, Local_1912[func_496() /*28*/].f_20);
			}
			if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tonya5")) == 1)
			{
				if (!iLocal_499)
				{
					GlobalFunc_173(&uLocal_526, 3, *uParam8, "TONYA", 0, 1);
...
int func_453(var uParam0, var uParam1, struct<3> Param2, var uParam5, var uParam6, var uParam7, float fParam8, char* sParam9, var uParam10, int iParam11)//Position - 0x35F80
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void func_455(var uParam0)//Position - 0x361E5
{
	int iVar0;
...
int func_457()//Position - 0x36341
{
	...
	switch (iLocal_2945)
	{
		...
		case 4:
			if ((iLocal_2944 == 8 && bLocal_510) || func_458())
			{
		...
		case 5:
			...
			{
				if (func_292(&iLocal_2942, 0, "TOW_TRAIN1"))
				{
					iLocal_2945 = 6;
				}
			}
...
int func_465(int iParam0)//Position - 0x36FD7
{
	float fVar0;
...
void func_466()//Position - 0x3705B
{
	if (!ENTITY::IS_ENTITY_DEAD(Local_2778[0 /*20*/].f_7) && !ENTITY::IS_ENTITY_DEAD(Local_2778[0 /*20*/].f_6))
	{
		if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(Local_2778[0 /*20*/].f_7, Local_2778[0 /*20*/].f_6))
...
int func_467()//Position - 0x370E8
{
	switch (iLocal_2943)
	{
						...
						else
						{
							if (!ENTITY::IS_ENTITY_DEAD(Local_2778[0 /*20*/]))
							{
								...
								if (ENTITY::DOES_ENTITY_EXIST(Local_2778[0 /*20*/]))
								{
									...
									func_472(Local_2778[0 /*20*/], uLocal_2767, 1);
								}
								bLocal_2715 = true;
							}
		...
		case 2:
			if (!ENTITY::IS_ENTITY_DEAD(Local_2778[0 /*20*/]))
			{
				if (!PED::IS_PED_IN_ANY_VEHICLE(Local_2778[0 /*20*/], 0))
				{
					...
					{
						if (func_470() || !VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iLocal_2933, Local_2778[0 /*20*/].f_6))
						{
							GlobalFunc_4935();
							iLocal_2943 = 5;
						}
		...
		case 4:
			...
			GlobalFunc_173(&Local_2390, iLocal_2838, Local_2778[0 /*20*/], sLocal_2657, 0, 1);
			bLocal_2710 = true;
			func_469(Local_2390, "TOWAUD", sLocal_2651, 0);
			SYSTEM::SETTIMERA(0);
			if (bLocal_2715)
			{
				GlobalFunc_6877(&uLocal_2897);
...
void func_468(bool bParam0)//Position - 0x3790C
{
	int iVar0;
	float fVar1;
...
void func_469(struct<165> Param0, char* sParam165, char* sParam166, bool bParam167)//Position - 0x37A92
{
	if (bParam167)
	{
		AUDIO::STOP_SCRIPTED_CONVERSATION(0);
...
int func_472(int iParam0, var uParam1, int iParam2)//Position - 0x37C3C
{
	int iVar0;
...
int func_476(int iParam0, int iParam1, struct<7> Param2, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, char* sParam24, var uParam25, bool bParam26, var uParam27)//Position - 0x37D4C
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	...
	if (iLocal_2643 != 12)
	{
		func_480(Param2, iParam0, iParam1);
	}
	if (!bLocal_509)
	{
		...
		switch (iLocal_2643)
		{
			case 0:
				if (GlobalFunc_7606(iParam1, iParam0, &iLocal_2645, 10, 90f, 100f, 0))
				{
					...
					GlobalFunc_173(&Local_2390, 3, *uParam27, "TONYA", 0, 1);
					GlobalFunc_173(&Local_2390, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
...
void func_477()//Position - 0x38324
{
	switch (iLocal_518)
	{
		case 0:
...
void func_478()//Position - 0x38401
{
	if (!iLocal_501)
	{
		if (!HUD::IS_MESSAGE_BEING_DISPLAYED())
...
void func_480(struct<7> Param0, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, int iParam20, int iParam21)//Position - 0x38450
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_481(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)//Position - 0x3851E
{
	int iVar0;
...
void func_482()//Position - 0x386F2
{
	if (iLocal_2940 < 16)
	{
		switch (iLocal_2884)
...
int func_483(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5)//Position - 0x388BA
{
	int iVar0;
...
void func_491(int iParam0, var uParam1, var uParam2, var uParam3, char* sParam4, var uParam5, int iParam6, bool bParam7, var uParam8, bool bParam9, var uParam10, bool bParam11, int iParam12, bool bParam13)//Position - 0x38BD1
{
	int iVar0;
...
void func_495()//Position - 0x3909A
{
	switch (iLocal_462)
	{
		case 2:
...
int func_496()//Position - 0x39123
{
	return Local_692[iLocal_2646 /*23*/].f_22;
}


int func_498(float fParam0, int iParam1, int iParam2)//Position - 0x391D0
{
	float fVar0;
	int iVar1;
	float fVar2;
...
void func_500()//Position - 0x392B6
{
...
void func_503()//Position - 0x3AF92
{
	if (!iLocal_3340)
	{
		if (bLocal_510)
		{
			PATHFIND::SET_ROADS_BACK_TO_ORIGINAL_IN_ANGLED_AREA(132.1304f, -2597.912f, 0.004743f, 340.5726f, -2511.293f, 11.7885f, 70f, 1);
			VEHICLE::REMOVE_ROAD_NODE_SPEED_ZONE(uLocal_3342);
			VEHICLE::REMOVE_ROAD_NODE_SPEED_ZONE(uLocal_3343);
			iLocal_3340 = 1;
		}
	}
}

void func_504()//Position - 0x3AFE3
{
	if (GlobalFunc_4903(&iLocal_3329, 0, 0))
	{
	...
	switch (iLocal_3317)
	{
		...
		case 1:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_3329))
			{
				...
				{
					if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_3331, 50f, 50f, 50f, 0, 1, 0))
					{
						iLocal_3329 = VEHICLE::CREATE_VEHICLE(joaat("towtruck"), Local_2573, fLocal_2576, 1, 1);
						iLocal_2933 = iLocal_3329;
						ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_2933, 1, 0);
						AUDIO::SET_VEH_RADIO_STATION(iLocal_2933, "RADIO_03_HIPHOP_NEW");
						MISC::CLEAR_AREA(Local_2573, 25f, 1, 0, 0, 0);
					}
					else
					{
						iLocal_3329 = VEHICLE::CREATE_VEHICLE(joaat("towtruck"), Local_3331, fLocal_3334, 1, 1);
						iLocal_2933 = iLocal_3329;
						ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_2933, 1, 0);
						AUDIO::SET_VEH_RADIO_STATION(iLocal_2933, "RADIO_03_HIPHOP_NEW");
						MISC::CLEAR_AREA(Local_3331, 25f, 1, 1, 0, 0);
					}
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_3329))
					{
			...
			{
				if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(iLocal_3329, -1) == PLAYER::PLAYER_PED_ID() || GlobalFunc_4903(&iLocal_3329, 0, 0))
				{
					iLocal_3317 = 2;
				}
			}
...
void func_507()//Position - 0x3B39C
{
...
void func_508()//Position - 0x3B425
{
	if (CAM::IS_SCREEN_FADED_OUT())
	{
		AUDIO::STOP_SCRIPTED_CONVERSATION(0);
		...
		HUD::CLEAR_HELP(1);
		GlobalFunc_553(835);
		MISC::CLEAR_AREA(Local_3344, 8f, 1, 0, 0, 0);
		GlobalFunc_5108(iLocal_2933, -1, 1);
		Local_2853 = { Local_2853 };
		fLocal_2856 = fLocal_2856;
...
void func_511()//Position - 0x3B56A
{
	if (CAM::IS_SCREEN_FADED_OUT())
	{
		func_512();
...
void func_512()//Position - 0x3B5BD
{
	func_513(405.7806f, -1652.369f, 28.2928f, 139.8366f);
	STREAMING::REQUEST_MODEL(joaat("towtruck"));
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_2933))
	{
		iLocal_2933 = VEHICLE::CREATE_VEHICLE(joaat("towtruck"), Local_3331, fLocal_3334, 1, 1);
		VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_2933);
		VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(iLocal_2933, 1);
	}
}

void func_513(struct<3> Param0, float fParam3)//Position - 0x3B62C
{
	int iVar0;
...
int func_514(struct<3> Param0, float fParam3)//Position - 0x3B6CB
{
	return func_515(&(Global_93588.f_2167), Param0, fParam3, 0);
}

int func_515(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x3B6E5
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
void func_525(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x3C01D
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (bParam3)
		{
			GlobalFunc_4971(&iParam0, &(uParam1->f_9), &(uParam1->f_35));
		}
...
void func_537()//Position - 0x3C780
{
	if (CAM::IS_SCREEN_FADED_OUT())
	{
		func_538();
...
void func_538()//Position - 0x3C7B7
{
	func_513(Local_2573, fLocal_2576);
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID()))
	{
		if (!GlobalFunc_188())
		{
			ENTITY::SET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), Local_3344, 1, 0, 0, 1);
			ENTITY::SET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID(), fLocal_3347);
		}
...
void func_546(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, int iParam7)//Position - 0x3C937
{
	uParam1 = uParam1;
	if (!bLocal_503)
	{
...
void func_552(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x3CDC5
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_568(var uParam0)//Position - 0x3D7F9
{
	int iVar0;
...
void func_569(var uParam0)//Position - 0x3D887
{
	func_570(uParam0, &(uParam0->f_2), uParam0->f_1);
}

void func_570(var uParam0, char* sParam1, int iParam2)//Position - 0x3D89D
{
	if (MISC::IS_BIT_SET(*uParam0, 30))
	{
		switch (GlobalFunc_4585(*uParam0))
		{
			...
			case 4:
				VEHICLE::REQUEST_VEHICLE_RECORDING(iParam2, uParam1);
				break;
...
void func_574()//Position - 0x3D9CF
{
	GlobalFunc_53();
	if (GlobalFunc_9574())
	{
	}
	func_576(&Local_2981, 1, 0, 0);
...
void func_576(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x3DA97
{
	GlobalFunc_7101(uParam0, iParam1);
	func_581(uParam0, bParam2);
...
void func_581(var uParam0, bool bParam1)//Position - 0x3DB6D
{
	func_582(&(uParam0->f_35), bParam1);
}

void func_582(var uParam0, bool bParam1)//Position - 0x3DB7F
{
	int iVar0;
...
void func_583(int iParam0)//Position - 0x3DBBC
{
...
void func_591(var uParam0, bool bParam1)//Position - 0x3DE24
{
	int iVar0;
