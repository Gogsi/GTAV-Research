			...
			case 2:
				...
				if (iLocal_99 == 1)
				{
					...
					if (iLocal_472 > 0)
					{
						...
						{
							if (GlobalFunc_4924(Local_131[iVar0 /*20*/]))
							{
		...
		case 1:
			...
			else
			{
				...
				if (iLocal_101 == 4)
				{
					...
					else if (GlobalFunc_4924(Local_384))
					{
...
{
	if (GlobalFunc_4924(Local_131[iParam0 /*20*/]))
	{
...
int func_468()//Position - 0x2F2C3
{
	...
	if (iLocal_472 > 0)
	{
		...
		while (iVar2 <= (iLocal_472 - 1))
		{
			...
			{
				if (GlobalFunc_4924(Local_131[iVar2 /*20*/]))
				{
