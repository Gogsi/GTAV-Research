...
float func_7()//Position - 0x468
{
	...
	fVar0 = 1f;
	iVar1 = GlobalFunc_5475(PLAYER::PLAYER_PED_ID());
	iVar2 = GlobalFunc_5472(PLAYER::PLAYER_PED_ID());
	if (iVar2 == 0)
	{
		if (iVar1 != 0)
		{
...
void func_14(int iParam0)//Position - 0x619
{
	...
	{
		GlobalFunc_866(iParam0);
		return;
	}
	if (GlobalFunc_5459(Global_35734[iParam0 /*5*/].f_1))
	{
		GlobalFunc_866(iParam0);
		return;
	}
