...
void func_60(int iParam0)//Position - 0x32C0
{
	...
	while (iVar15 < Global_SAVE_DATA.COMM_CONTROL_DATA_STRUCT.No_Missed_Calls)
	{
		...
		{
			func_61(Global_SAVE_DATA.COMM_CONTROL_DATA_STRUCT.COMM_CONTROL_MISSED_CALLS_ARRAY[iVar15 /*15*/].f_6);
			iVar16 = iVar15;
	...
	if (MISC::IS_BIT_SET(Global_SAVE_DATA.SAVED_RANDOM_CHARACTERS[iParam0 /*6*/], 0) && !MISC::IS_BIT_SET(Global_SAVE_DATA.SAVED_RANDOM_CHARACTERS[iParam0 /*6*/], 3))
	{
		...
		if (MISC::IS_BIT_SET(Global_SAVE_DATA.SAVED_RANDOM_CHARACTERS[iParam0 /*6*/], 1))
		{
			if (!MISC::IS_BIT_SET(Global_SAVE_DATA.SAVED_RANDOM_CHARACTERS[iParam0 /*6*/], 2))
			{
				...
				{
					if (!func_22(Global_SAVE_DATA.SAVED_RANDOM_CHARACTERS[iParam0 /*6*/].f_2))
					{
						func_116(Global_SAVE_DATA.SAVED_RANDOM_CHARACTERS[iParam0 /*6*/].f_2, &uVar35, &uVar36, &uVar37, &iVar38, &iVar39, &iVar40);
						if ((iVar40 > 0 || iVar39 > 0) || iVar38 > 10)
						{
							Var57 = { func_20(iParam0) };
							Global_SAVE_DATA.SAVED_RANDOM_CHARACTERS[iParam0 /*6*/].f_2 = func_41();
							func_33(&(Global_SAVE_DATA.SAVED_RANDOM_CHARACTERS[iParam0 /*6*/].f_2), 0, 0, Var0.f_15, 0, 0, 0);
						}
						bVar34 = false;
					}
				}
...
void func_87(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x46F5
{
	...
	if (bParam1)
	{
		if (!bParam3)
		{
			Global_Mission_Blips[iVar0 /*23*/].f_17 = iParam2;
			if (bParam1 != MISC::IS_BIT_SET(Global_Mission_Blips[iVar0 /*23*/].f_11, 8))
			{
				MISC::SET_BIT(&(Global_Mission_Blips[iVar0 /*23*/].f_11), 18);
			}
			MISC::SET_BIT(&(Global_Mission_Blips[iVar0 /*23*/].f_11), 8);
		}
		else
		{
			Global_Mission_Blips[iVar0 /*23*/].f_18 = iParam2;
			if (bParam1 != MISC::IS_BIT_SET(Global_Mission_Blips[iVar0 /*23*/].f_11, 10))
			{
				MISC::SET_BIT(&(Global_Mission_Blips[iVar0 /*23*/].f_11), 18);
			}
			MISC::SET_BIT(&(Global_Mission_Blips[iVar0 /*23*/].f_11), 10);
		}
		MISC::SET_BIT(&(Global_Mission_Blips[iVar0 /*23*/].f_11), 18);
	}
	else
...
void func_89(int iParam0)//Position - 0x47F0
{
	...
	if (MISC::IS_BIT_SET(Global_Mission_Blips[iVar0 /*23*/].f_11, 8) || MISC::IS_BIT_SET(Global_Mission_Blips[iVar0 /*23*/].f_11, 10))
	{
		MISC::SET_BIT(&(Global_Mission_Blips[iVar0 /*23*/].f_11), 18);
	}
	MISC::CLEAR_BIT(&(Global_Mission_Blips[iVar0 /*23*/].f_11), 8);
	MISC::CLEAR_BIT(&(Global_Mission_Blips[iVar0 /*23*/].f_11), 10);
	MISC::SET_BIT(&(Global_Mission_Blips[iVar0 /*23*/].f_11), 18);
}
...
void func_92(int iParam0, int iParam1)//Position - 0x4C51
{
	...
	MISC::SET_BITS_IN_RANGE(&(Global_Mission_Blips[iVar0 /*23*/].f_11), 21, 26, iParam1);
	if (Global_24745 == 1)
	{
		Global_24746 = 1;
	}
