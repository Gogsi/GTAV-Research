...
void func_14()//Position - 0xCE0
{
	...
	{
		func_16(13, SYSTEM::FLOOR(Global_SAVE_DATA.COMP_PERCENT_SAVED_ARRAY.f_3853));
	}
...
int func_40(int iParam0, int iParam1, int iParam2)//Position - 0x2075
{
	...
	{
		if (!func_154(iParam0, Global_SAVE_DATA.COMPONENTS_ARRAY.PP_INFO_STRUCT[iVar0 /*65*/].f_64, Global_SAVE_DATA.COMPONENTS_ARRAY.PP_INFO_STRUCT[iVar0 /*65*/].f_63))
		{
...
int func_80(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x77EF
{
	...
	{
		if (!func_154(iParam0, Global_SAVE_DATA.COMPONENTS_ARRAY.PP_INFO_STRUCT[iVar0 /*65*/].f_61, Global_SAVE_DATA.COMPONENTS_ARRAY.PP_INFO_STRUCT[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_88(&Var1, -99, -99, Global_SAVE_DATA.COMPONENTS_ARRAY.PP_INFO_STRUCT.f_196[0], Global_SAVE_DATA.COMPONENTS_ARRAY.PP_INFO_STRUCT.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_88(&Var1, -99, -99, Global_SAVE_DATA.COMPONENTS_ARRAY.PP_INFO_STRUCT.f_196[1], Global_SAVE_DATA.COMPONENTS_ARRAY.PP_INFO_STRUCT.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_88(&Var1, -99, -99, Global_SAVE_DATA.COMPONENTS_ARRAY.PP_INFO_STRUCT.f_196[2], Global_SAVE_DATA.COMPONENTS_ARRAY.PP_INFO_STRUCT.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_160()//Position - 0x1E15A
{
	...
	{
		if (func_156(Global_SAVE_DATA.COMPONENTS_ARRAY.PP_INFO_STRUCT.f_3213) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_155(PLAYER::PLAYER_PED_ID());
			if (func_157(iVar0) && (!func_96(14) || Global_96306))
			{
				if (Global_SAVE_DATA.COMPONENTS_ARRAY.PP_INFO_STRUCT.f_3213 != iVar0 && func_157(Global_SAVE_DATA.COMPONENTS_ARRAY.PP_INFO_STRUCT.f_3213))
				{
...
void func_171()//Position - 0x1FDE2
{
	...
	{
		func_160();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_172(Global_SAVE_DATA.COMPONENTS_ARRAY.PP_INFO_STRUCT.f_3213));
	}
	else
	{
...
void func_177(int iParam0, bool bParam1)//Position - 0x1FEEF
{
		...
		if (Var0.f_5 != 4)
		{
			...
			while (iVar34 < 63)
			{
				...
				if (iVar67 != iParam0)
				{
					...
					{
						if (!MISC::IS_BIT_SET(Global_SAVE_DATA.SAVED_RANDOM_CHARACTERS[iVar67 /*6*/], 3))
						{
							bVar33 = false;
						}
						if (!MISC::IS_BIT_SET(Global_SAVE_DATA.SAVED_RANDOM_CHARACTERS[iVar67 /*6*/], 0))
						{
							func_182(iVar67);
						}
					}
	...
	{
		MISC::SET_BIT(&(Global_SAVE_DATA.SAVED_RANDOM_CHARACTERS[iParam0 /*6*/]), 3);
...
{
	func_181(iParam0, 1);
	Global_SAVE_DATA.SAVED_RANDOM_CHARACTERS[iParam0 /*6*/].f_3 = func_180();
	Global_SAVE_DATA.SAVED_RANDOM_CHARACTERS.iRCMissionsCompleted++;
}

int func_180()//Position - 0x20435
{
	return (Global_SAVE_DATA.FLOW_CUSTOM_STRUCT.iMissionsCompleted + Global_SAVE_DATA.SAVED_RANDOM_CHARACTERS.iRCMissionsCompleted);
}
...
void func_181(var uParam0, bool bParam1)//Position - 0x20451
{
	...
	if (iVar0 != 55)
	{
		Global_SAVE_DATA.FINANCE_SAVED_ARRAY.f_472 = iVar0;
	}
}
...
int func_194(int iParam0)//Position - 0x24B00
{
	switch (iParam0)
	{
		...
		case 43:
			if (Global_SAVE_DATA.FLOW_STRUCT.MF_CONTROLS_STRUCT.f_58[101])
			{
				return 53;
			}
			else
...
void func_196(int iParam0, bool bParam1)//Position - 0x24C43
{
	...
	if (iVar0 >= 0 && iVar0 <= 31)
	{
		if (!MISC::IS_BIT_SET(Global_SAVE_DATA.BitsetCharacterStoryUnlock, iVar0))
		{
			MISC::SET_BIT(&(Global_SAVE_DATA.BitsetCharacterStoryUnlock), iVar0);
			if (!bParam1)
			{
...
int is_dialogue_playing()//Position - 0x25720
{
	...
	switch (iLocal_320)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				{
					give_checkpoint(5, "Player has finished shooting the coyote", 1, 0, 0, 1);
...
void give_checkpoint(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x259B7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_247(int iParam0, bool bParam1)//Position - 0x27FD0
{
	...
	if (func_157(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_248(iParam0, &(Global_SAVE_DATA.COMPONENTS_ARRAY.PP_INFO_STRUCT.f_298[iVar0 /*284*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
int func_280(int iParam0)//Position - 0x2AA19
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_281(Global_SAVE_DATA.FLOW_STRUCT.MF_CONTROLS_STRUCT.f_203[10]);
			break;
		
		case 74:
		case 75:
			return func_281(Global_SAVE_DATA.FLOW_STRUCT.MF_CONTROLS_STRUCT.f_203[8]);
			break;
		
		case 84:
		case 85:
			return func_281(Global_SAVE_DATA.FLOW_STRUCT.MF_CONTROLS_STRUCT.f_203[11]);
			break;
		
		case 90:
			return func_281(Global_SAVE_DATA.FLOW_STRUCT.MF_CONTROLS_STRUCT.f_203[7]);
			break;
		
		case 93:
			return func_281(Global_SAVE_DATA.FLOW_STRUCT.MF_CONTROLS_STRUCT.f_203[9]);
			break;
	}
	return 0;
}
...
void func_287()//Position - 0x2AE4C
{
	...
	if (numCoyotesKilled < 3)
	{
		if (!bLocal_640)
		{
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_768, Local_771, 20f, 0, 1, 0))
			{
				...
				if (iLocal_658[17])
				{
					if (!is_dialogue_playing() || MISC::GET_PROFILE_SETTING(203) == 0)
					{
						if (!iLocal_632)
						{
							if (numCoyotesKilled == 0)
							{
								Display_Help_Message("HT_SHCOY");
							}
							else if (numCoyotesKilled == 1)
							{
								Display_Help_Message("HT_2MORE");
							}
							else if (numCoyotesKilled == 2)
							{
								Display_Help_Message("HT_1MORE");
							}
							iLocal_632 = 1;
						}
					}
				}
				else if (numCoyotesKilled != 0)
				{
					iLocal_318 = 1;
					func_295(6);
				}
			...
			else
			{
				...
				func_291(0, 0);
				Display_Help_Message("HT_BKHTER");
				iLocal_317 = 15;
			}
		}
		else
	...
	else
	{
		...
		if (iLocal_658[20]) // Cletus started putting down binoculars
		{
			if (!is_dialogue_playing() || MISC::GET_PROFILE_SETTING(203) == 0)
			{
				if (!is_ped_aiming_sniper(PLAYER::PLAYER_PED_ID()))
				{
					give_checkpoint(5, "Player has finished shooting the coyote", 1, 0, 0, 1);
					func_288();
					func_218(0);
...
int is_ped_aiming_sniper(int iParam0)//Position - 0x2B0E2
{
	int iVar0;
...
void Display_Help_Message(char* sParam0)//Position - 0x2B2B6
{
...
{
	if ((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_768, Local_771, 20f, 0, 1, 0) && ENTITY::DOES_ENTITY_EXIST(Local_498[iParam0 /*54*/][iParam1 /*17*/].f_6)) && !ENTITY::IS_ENTITY_DEAD(Local_498[iParam0 /*54*/][iParam1 /*17*/].f_6)) && iLocal_632) && numCoyotesKilled < 3)
	{
...
void func_323()//Position - 0x2CA35
{
	switch (iLocal_320)
	{
		...
		case 1:
			...
			{
				func_331();
				give_checkpoint(3, "Player has finished shooting all the car tyres", 1, 0, 0, 1);
				func_329();
				func_328();
				iLocal_318 = 20;
				TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
...
void func_337()//Position - 0x2CF3E
{
	...
	while (iVar0 < 5)
	{
		...
		switch (Local_352[iVar0 /*29*/].f_13)
		{
			...
			case 1:
				if (iLocal_704 < 3 && numCoyotesKilled < 3)
				{
...
void func_343()//Position - 0x2E0A8
{
	...
	{
		if (func_345() && !is_dialogue_playing())
		{
	...
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_762, Local_765, 10f, 0, 1, 0))
	{
		if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (!iLocal_614)
			{
				if (!is_dialogue_playing())
				{
					Display_Help_Message("HT_SHTYRE");
					iLocal_614 = 1;
				}
			}
			if (!bLocal_640)
...
void func_357()//Position - 0x2E683
{
	...
	switch (iLocal_320)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				give_checkpoint(2, "Player has finished shooting all the satellite dishes", 0, 0, 0, 1);
				iLocal_318 = 13;
...
void func_364()//Position - 0x2EBFC
{
	...
	if (!bLocal_629)
	{
		...
		Display_Help_Message("HT_NXTLOC");
		iLocal_317 = 9;
	}
	if (func_334())
	{
	...
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_756, Local_759, 7f, 0, 1, 0))
	{
		...
		if (!is_dialogue_playing() || MISC::GET_PROFILE_SETTING(203) == 0)
		{
			if (!iLocal_636)
			{
				func_8(&iLocal_609);
				func_373();
				Display_Help_Message("HT_SHDISH");
				iLocal_636 = 1;
			}
		}
		if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && (ENTITY::IS_ENTITY_AT_COORD(iLocal_733, Local_777, 2f, 2f, 2f, 0, 1, 0) || numCoyotesKilled >= 3))
		{
			if (!bLocal_640)
			{
				if (numCoyotesKilled >= 3)
	...
	switch (iLocal_320)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				func_8(&iLocal_608);
				func_220(1);
				give_checkpoint(1, "Player has reached the satellite dishes", 0, 0, 0, 1);
				if (func_381())
				{
					func_325();
					func_380();
		...
		switch (iLocal_318)
		{
			...
			case 7:
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_756, Local_759, 7f, 0, 1, 0))
				{
					...
					if (func_453())
					{
						...
						if (numCoyotesKilled == 1 && func_447())
						{
							if (!iLocal_645[0])
							{
						...
						else if (numCoyotesKilled == 2 && func_447())
						{
							if (!iLocal_645[1])
							{
			...
			case 15:
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_762, Local_765, 10f, 0, 1, 0))
				{
					...
					if (func_453())
					{
						...
						if (numCoyotesKilled == 1 && !iLocal_645[0])
						{
						...
						else if (numCoyotesKilled == 2 && !iLocal_645[1])
						{
			...
			case 21:
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_768, Local_771, 20f, 0, 1, 0))
				{
					if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_733, 713668775) == 7)
					{
						if ((func_344(&uLocal_152, cLocal_738, "HUNT1_COARR", 7, 0, 0, 0) || numCoyotesKilled > 0) || iLocal_713 == 1)
						{
							RECORDING::_0x293220DA1B46CEBC(3f, 5f, 4);
							iLocal_713 = 0;
							iLocal_658[17] = 1;
			...
			case 22:
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_768, Local_771, 20f, 0, 1, 0))
				{
					...
					if (numCoyotesKilled >= 3 && !bLocal_625)
					{
						func_293();
					...
					if (func_453())
					{
						func_353();
						func_448(2);
						if (numCoyotesKilled == 1 && !iLocal_658[18])
						{
							if (!is_dialogue_playing())
							{
						...
						if (numCoyotesKilled == 2 && !iLocal_658[19])
						{
							if (!is_dialogue_playing())
							{
			...
			case 23:
				if (func_445())
				{
					if (!is_dialogue_playing() && !is_ped_aiming_sniper(PLAYER::PLAYER_PED_ID()))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_733, PLAYER::PLAYER_PED_ID(), -1);
						iLocal_658[20] = 1;
						iLocal_318 = 25;
	...
	if (!PED::IS_PED_DEAD_OR_DYING(iLocal_733, 1) && !PED::IS_PED_DEAD_OR_DYING(PLAYER::PLAYER_PED_ID(), 1))
	{
		if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_756, Local_759, 7f, 0, 1, 0))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_733, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
			{
				...
				{
					if (!is_dialogue_playing() && func_345())
					{
						if (!iLocal_658[6])
						{
...
void func_443()//Position - 0x329E3
{
	...
	{
		if ((iLocal_682[1] && !func_371("HT_NXTLOC", 0, 0)) && !is_dialogue_playing())
		{
			if (!iLocal_642)
			{
...
void func_448(int iParam0)//Position - 0x32C61
{
	...
	if (((numCoyotesKilled < 3 && !func_371("HT_SHDISH", 0, 0)) && !func_371("HT_SHTYRE", 0, 0)) && !func_371("HT_SHCOY", 0, 0))
	{
		if (iLocal_623)
		{
			if (MISC::GET_GAME_TIMER() > iLocal_711)
			{
				...
				{
					if ((func_322() || iLocal_708 > 2) || numCoyotesKilled == 0)
					{
				...
				{
					if ((func_322() || iLocal_724 > 2) || numCoyotesKilled == 0)
					{
						if (func_344(&uLocal_152, cLocal_738, sVar0, 7, 0, 0, 0))
						{
							iLocal_623 = 0;
