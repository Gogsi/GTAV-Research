				...
				case 3:
					...
					else
					{
						...
						if (bVar2)
						{
							...
							if (bVar2 && GlobalFunc_469(GlobalFunc_8329()) < iLocal_118)
							{
								GlobalFunc_5211(&uLocal_93, 128);
								bVar2 = false;
								if (!GlobalFunc_747(uLocal_93, 33554432))
								{
									GlobalFunc_2154("MG_YOU_IS_BROKE", iLocal_118, -1);
								...
								if (GlobalFunc_82(uLocal_85))
								{
									if (iLocal_95 == -1)
									{
										if (iLocal_118 > 0)
										{
											...
											GlobalFunc_2989(sLocal_100, iLocal_118);
...
void func_38()//Position - 0x15B3
{
	...
	if (iLocal_137 == 0)
	{
		...
		if (GlobalFunc_747(uLocal_93, 128))
		{
			if (GlobalFunc_474(90))
			{
				GlobalFunc_2436(90, 0, 0);
			}
		}
		else if (!GlobalFunc_474(90))
		{
			GlobalFunc_2436(90, 1, 0);
		}
	}
	else
	{
		...
		if (GlobalFunc_747(uLocal_93, 128))
		{
			if (GlobalFunc_474(91))
			{
				GlobalFunc_2436(91, 0, 0);
			}
		}
		else if (!GlobalFunc_474(91))
		{
			GlobalFunc_2436(91, 1, 0);
		}
	}
	...
	if (GlobalFunc_8624(28) || GlobalFunc_8624(38))
	{
		func_39();
...
void func_98()//Position - 0x39D4
{
	...
	fLocal_116 = 2f;
	fLocal_101 = (SYSTEM::TO_FLOAT(GlobalFunc_4523(90)) + 5f);
	iLocal_98 = 11;
	if (GlobalFunc_892(0, iLocal_98))
	{
		GlobalFunc_2436(90, 1, 0);
...
void func_103(bool bParam0)//Position - 0x3BC1
{
	...
	if (GlobalFunc_747(uLocal_93, 2048))
	{
		if (GlobalFunc_473(sLocal_100, iLocal_118))
		{
			GlobalFunc_5312(&uLocal_93, 2048);
			HUD::CLEAR_HELP(0);
		}
