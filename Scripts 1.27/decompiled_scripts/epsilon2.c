...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_31 = 180f;
	iLocal_34 = 3;
	uLocal_82 = GlobalFunc_4946(60);
	uLocal_83 = GlobalFunc_4946(14);
	...
	switch (iLocal_147)
	{
		...
		case 1:
			if (GlobalFunc_115(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					if (GlobalFunc_7022(1343538152, 6, 1, 60, 15000, 10000, -1, 0, -1, 0))
					{
						iLocal_152 = 1;
					}
				}
				if (!iLocal_154 && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 240.9832f, 358.8689f, 103.6005f, 246.0318f, 374.3415f, 109.6506f, 9f, 0, 1, 0))
				{
					if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 240.9832f, 358.8689f, 103.6005f, 246.0318f, 374.3415f, 109.6506f, 9f, 0, 1, 0))
					{
						...
						{
							GlobalFunc_10694(109, 6);
							GlobalFunc_10694(109, 1);
							iLocal_153 = 1;
							iLocal_154 = 1;
							func_251();
						}
	...
	switch (iLocal_147)
	{
		case 0:
			...
			if (func_207(1, 1093140480, 0))
			{
				...
				GlobalFunc_9165(&Local_85, 1, 0, 0);
				Global_2268 = 1;
				GlobalFunc_8954();
...
int func_60(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x51BA
{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			...
			{
				Global_68106[1 /*14*/] = { GlobalFunc_10856(iVar10, iVar0, func_69(iParam0, iVar0, -1)) };
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_173(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_173(iParam0, 14, uVar21[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_68106[2 /*14*/] = { GlobalFunc_10856(iVar0, 14, iVar4) };
					...
					else
					{
						...
						Global_68106[2 /*14*/] = { GlobalFunc_10856(iVar0, iVar2, iVar1) };
...
{
	GlobalFunc_9248(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}
...
void func_245()//Position - 0x2570A
{
	...
	GlobalFunc_8954();
	if (!iLocal_152 && GlobalFunc_2329(3) == -1)
	{
		GlobalFunc_5723(3, 0);
...
void func_252(int iParam0, bool bParam1)//Position - 0x25C7D
{
	...
	GlobalFunc_2832(&uVar1, GlobalFunc_8546());
	func_276();
