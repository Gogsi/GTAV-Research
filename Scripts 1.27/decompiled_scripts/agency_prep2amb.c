...
void __EntryFunction__()//Position - 0x0
{
	...
	{
		GlobalFunc_6677("AM_H_PREP8", 2, 0, -1, 10000, 3, 0, 0, 0);
...
void func_123()//Position - 0x5315
{
	...
	else if (GlobalFunc_785() == -1)
	{
		if (!MISC::IS_BIT_SET(uLocal_104, 1))
		{
			if (!GlobalFunc_775(PLAYER::PLAYER_PED_ID(), Local_105, 5f))
			{
				if (func_125())
				{
...
{
	if (!GlobalFunc_100(Local_109, 0f, 0f, 0f) && GlobalFunc_785() != func_129())
	{
...
int func_154()//Position - 0x7ACD
{
	if (MISC::IS_BIT_SET(uLocal_104, 0))
	{
		if (GlobalFunc_5201(iLocal_108))
		{
			if (MISC::IS_BIT_SET(uLocal_104, 1))
			{
				if ((GlobalFunc_791(0) || GlobalFunc_791(12)) || GlobalFunc_791(1))
				{
					func_155();
					func_1(46, 1);
					return 1;
...
{
	if ((MISC::IS_BIT_SET(uLocal_104, 0) && Global_34913 == 15) && !GlobalFunc_487())
	{
		if (iLocal_37 == 0)
		{
			if (!MISC::IS_BIT_SET(uLocal_104, 1) && MISC::IS_BIT_SET(uLocal_104, 0))
			{
				if (!GlobalFunc_775(PLAYER::PLAYER_PED_ID(), Local_105, 5f))
				{
					...
					{
						if ((GlobalFunc_5205(PLAYER::PLAYER_PED_ID()) && !MISC::IS_BIT_SET(uLocal_100[0], 17)) && !MISC::IS_BIT_SET(uLocal_100[1], 18))
						{
			...
			{
				if (!GlobalFunc_775(PLAYER::PLAYER_PED_ID(), Local_105, 10f))
				{
					MISC::CLEAR_BIT(&uLocal_104, 1);
				}
...
int func_166()//Position - 0x8194
{
	...
	while (iVar6 <= 4)
	{
		if (GlobalFunc_5205(uVar0[iVar6]) && uVar0[iVar6] != PLAYER::PLAYER_PED_ID())
		{
...
int func_169(struct<3> Param0)//Position - 0x8289
{
	...
	fVar0 = SYSTEM::VDIST2(Param0, Global_85506[GlobalFunc_792(Param0, 0) /*9*/].f_3);
	if (fVar0 <= 40000f)
	{
		return 1;
	}
...
int func_171(struct<3> Param0)//Position - 0x833B
{
	...
	fVar0 = SYSTEM::VDIST2(Param0, Global_85570[GlobalFunc_793(Param0, 0) /*9*/].f_3);
	if (fVar0 <= 40000f)
	{
		return 1;
	}
...
int func_175(struct<3> Param0)//Position - 0x8499
{
	...
	if (!GlobalFunc_794(16))
	{
		if (func_176(Param0, 16))
		{
			return 1;
		}
		if (!GlobalFunc_794(15))
		{
			if (func_176(Param0, 15))
			{
				return 1;
			}
			if (!GlobalFunc_794(14))
			{
				if (func_176(Param0, 14))
				{
					return 1;
				}
				if (!GlobalFunc_794(13))
				{
					...
					if (!GlobalFunc_794(12))
					{
						...
						if (!GlobalFunc_794(11))
						{
							if (func_176(Param0, 11))
							{
								return 1;
							}
							if (!GlobalFunc_794(10))
							{
	...
	if (!GlobalFunc_794(20))
	{
		if (func_176(Param0, 20))
		{
			return 1;
		}
		if (!GlobalFunc_794(19))
		{
			if (func_176(Param0, 19))
			{
				return 1;
			}
			if (!GlobalFunc_794(18))
			{
				if (func_176(Param0, 18))
				{
					return 1;
				}
				if (!GlobalFunc_794(17))
				{
	...
	if (!GlobalFunc_794(26))
	{
		if (!GlobalFunc_794(25))
		{
	...
	if (!GlobalFunc_794(30))
	{
		if (func_176(Param0, 30))
		{
			return 1;
		}
		if (!GlobalFunc_794(29))
		{
			if (func_176(Param0, 29))
			{
				return 1;
			}
			if (!GlobalFunc_794(28))
			{
				if (func_176(Param0, 28))
				{
					return 1;
				}
				if (!GlobalFunc_794(27))
				{
	...
	if (!GlobalFunc_794(34))
	{
		if (func_176(Param0, 34))
		{
			return 1;
		}
		if (!GlobalFunc_794(33))
		{
			if (func_176(Param0, 33))
			{
				return 1;
			}
			if (!GlobalFunc_794(32))
			{
	...
	if (!GlobalFunc_794(43))
	{
		if (func_176(Param0, 43))
		{
			return 1;
		}
		if (!GlobalFunc_794(42))
		{
			if (func_176(Param0, 42))
			{
				return 1;
			}
			if (!GlobalFunc_794(38))
			{
				if (func_176(Param0, 42))
				{
					return 1;
	...
	if (!GlobalFunc_794(45))
	{
		if (func_176(Param0, 45))
		{
			return 1;
		}
		if (!GlobalFunc_794(44))
		{
	...
	if (!GlobalFunc_794(51))
	{
		if (func_176(Param0, 51))
		{
			return 1;
		}
		if (!GlobalFunc_794(48))
		{
			if (func_176(Param0, 48))
			{
				return 1;
			}
			if (!GlobalFunc_794(49))
			{
			...
			if (!GlobalFunc_794(47))
			{
				if (func_176(Param0, 47))
				{
					return 1;
				}
				if (!GlobalFunc_794(46))
				{
	...
	if (!GlobalFunc_794(53))
	{
		if (func_176(Param0, 53))
		{
			return 1;
		}
		if (!GlobalFunc_794(56))
		{
			if (func_176(Param0, 56))
			{
				return 1;
			}
			if (!GlobalFunc_794(55))
			{
	...
	if (!GlobalFunc_794(62))
	{
		if (func_176(Param0, 62))
		{
			return 1;
		}
		if (!GlobalFunc_794(61))
		{
			if (func_176(Param0, 61))
			{
				return 1;
			}
			if (!GlobalFunc_794(60))
			{
				if (func_176(Param0, 60))
				{
					return 1;
				}
				if (!GlobalFunc_794(59))
				{
...
int func_183()//Position - 0x949B
{
	...
	iVar0 = GlobalFunc_4933(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 145, 1);
...
void func_191()//Position - 0x976D
{
	...
	if ((Global_34913 == 15 && iLocal_37 == 0) && !GlobalFunc_487())
	{
		if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
		{
			if (!MISC::IS_BIT_SET(uLocal_104, 0))
						...
						if (!MISC::IS_BIT_SET(uLocal_104, 7))
						{
							...
							if (GlobalFunc_5201(iVar0))
							{
								if (!GlobalFunc_797(iVar0))
								{
									...
									{
										if (func_195(iVar0) && !GlobalFunc_796())
										{
			...
			else if (GlobalFunc_5201(iLocal_108))
			{
				if (!GlobalFunc_155(PLAYER::PLAYER_PED_ID(), iLocal_108, 80f))
				{
					...
					{
						MISC::SET_BIT(&(uLocal_100[GlobalFunc_772(5)]), 5);
						MISC::SET_BIT(&uLocal_104, 8);
					}
					else
					{
...
int func_204(var uParam0)//Position - 0x9D3D
{
	...
	if (GlobalFunc_5205(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		iVar0 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
		if (GlobalFunc_5201(iVar0))
		{
...
void func_213()//Position - 0xA344
{
	if (iLocal_36 == 0 || iLocal_36 == 1)
	{
		...
		{
			case 0:
				if (GlobalFunc_165(func_3(3), 0, 0))
				{
					MISC::SET_BIT(&uLocal_104, 15);
					HUD::CLEAR_HELP(1);
				}
...
{
	if (((((Global_34913 == 15 && !GlobalFunc_487()) && Global_68242 == -1) && !GlobalFunc_784()) && !func_188(1112014848)) && !Global_96408)
	{
		return 1;
	}
	return 0;
