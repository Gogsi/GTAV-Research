...
void __EntryFunction__()//Position - 0x0
{
	...
	if (GlobalFunc_199())
	{
		func_883(&iLocal_545, GlobalFunc_198());
		iLocal_953 = 1;
		if (Global_84544 == 1)
		{
